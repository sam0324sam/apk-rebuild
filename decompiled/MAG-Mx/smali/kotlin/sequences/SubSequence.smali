...
.method public constructor <init>(Lkotlin/sequences/Sequence;II)V
    ...
    .line 308
    iget v5, p0, Lkotlin/sequences/SubSequence;->startIndex:I
    ...
    const-string v4, "startIndex should be non-negative, but is "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v4, p0, Lkotlin/sequences/SubSequence;->startIndex:I
    ...
    .line 309
    :cond_1
    iget v5, p0, Lkotlin/sequences/SubSequence;->endIndex:I
    ...
    .local v1, "$i$a$-require-SubSequence$2":I
    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "endIndex should be non-negative, but is "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v4, p0, Lkotlin/sequences/SubSequence;->endIndex:I
    ...
    .end local v1    # "$i$a$-require-SubSequence$2":I
    :cond_2
    move v5, v4
    ...
    iget v6, p0, Lkotlin/sequences/SubSequence;->startIndex:I
    ...
    .local v2, "$i$a$-require-SubSequence$3":I
    new-instance v3, Ljava/lang/StringBuilder;
    ...
    .end local v2    # "$i$a$-require-SubSequence$3":I
    :cond_4
    move v3, v4
