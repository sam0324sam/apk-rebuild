...
.method public get(Lkotlin/coroutines/experimental/CoroutineContext$Key;)Lkotlin/coroutines/experimental/CoroutineContext$Element;
    ...
    .line 36
    .local v1, "cur":Lkotlin/coroutines/experimental/CombinedContext;
    :goto_0
    nop

    .line 37
    iget-object v4, v1, Lkotlin/coroutines/experimental/CombinedContext;->element:Lkotlin/coroutines/experimental/CoroutineContext$Element;

    invoke-interface {v4, p1}, Lkotlin/coroutines/experimental/CoroutineContext$Element;->get(Lkotlin/coroutines/experimental/CoroutineContext$Key;)Lkotlin/coroutines/experimental/CoroutineContext$Element;

    move-result-object v2

    if-eqz v2, :cond_0

    .local v2, "it":Lkotlin/coroutines/experimental/CoroutineContext$Element;
    const/4 v0, 0x0

    .line 42
    .end local v2    # "it":Lkotlin/coroutines/experimental/CoroutineContext$Element;
    :goto_1
    return-object v2

    .line 38
    :cond_0
    iget-object v3, v1, Lkotlin/coroutines/experimental/CombinedContext;->left:Lkotlin/coroutines/experimental/CoroutineContext;

    .line 39
    .local v3, "next":Lkotlin/coroutines/experimental/CoroutineContext;
    instance-of v4, v3, Lkotlin/coroutines/experimental/CombinedContext;
    ...
    .line 42
    :cond_1
    invoke-interface {v3, p1}, Lkotlin/coroutines/experimental/CoroutineContext;->get(Lkotlin/coroutines/experimental/CoroutineContext$Key;)Lkotlin/coroutines/experimental/CoroutineContext$Element;
...
.method public minusKey(Lkotlin/coroutines/experimental/CoroutineContext$Key;)Lkotlin/coroutines/experimental/CoroutineContext;
    ...
    invoke-interface {v3, p1}, Lkotlin/coroutines/experimental/CoroutineContext;->minusKey(Lkotlin/coroutines/experimental/CoroutineContext$Key;)Lkotlin/coroutines/experimental/CoroutineContext;

    move-result-object v2

    .line 53
    .local v2, "newLeft":Lkotlin/coroutines/experimental/CoroutineContext;
    nop
    ...
    iget-object v4, p0, Lkotlin/coroutines/experimental/CombinedContext;->element:Lkotlin/coroutines/experimental/CoroutineContext$Element;

    invoke-direct {v3, v2, v4}, Lkotlin/coroutines/experimental/CombinedContext;-><init>(Lkotlin/coroutines/experimental/CoroutineContext;Lkotlin/coroutines/experimental/CoroutineContext$Element;)V
