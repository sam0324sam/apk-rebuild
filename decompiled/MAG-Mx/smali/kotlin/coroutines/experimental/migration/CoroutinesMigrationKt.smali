...
.method public static final toCoroutineContext(Lkotlin/coroutines/experimental/CoroutineContext;)Lkotlin/coroutines/CoroutineContext;
    ...
    .prologue
    const-string v5, "$this$toCoroutineContext"
    ...
    invoke-interface {p0, v5}, Lkotlin/coroutines/experimental/CoroutineContext;->get(Lkotlin/coroutines/experimental/CoroutineContext$Key;)Lkotlin/coroutines/experimental/CoroutineContext$Element;
    ...
    sget-object v5, Lkotlin/coroutines/experimental/migration/ExperimentalContextMigration;->Key:Lkotlin/coroutines/experimental/migration/ExperimentalContextMigration$Key;
    ...
    invoke-interface {p0, v5}, Lkotlin/coroutines/experimental/CoroutineContext;->minusKey(Lkotlin/coroutines/experimental/CoroutineContext$Key;)Lkotlin/coroutines/experimental/CoroutineContext;
    ...
    invoke-interface {v6, v5}, Lkotlin/coroutines/experimental/CoroutineContext;->minusKey(Lkotlin/coroutines/experimental/CoroutineContext$Key;)Lkotlin/coroutines/experimental/CoroutineContext;

    move-result-object v3

    .line 52
    .local v3, "remainder":Lkotlin/coroutines/experimental/CoroutineContext;
    if-eqz v1, :cond_0
    ...
    .line 53
    .local v2, "original":Lkotlin/coroutines/CoroutineContext;
    :goto_0
    sget-object v5, Lkotlin/coroutines/experimental/EmptyCoroutineContext;->INSTANCE:Lkotlin/coroutines/experimental/EmptyCoroutineContext;
    ...
    .end local v4    # "result":Lkotlin/coroutines/CoroutineContext;
    :goto_2
    return-object v4

    .line 52
    .end local v2    # "original":Lkotlin/coroutines/CoroutineContext;
    :cond_0
    ...
    .line 53
    .restart local v2    # "original":Lkotlin/coroutines/CoroutineContext;
    :cond_1
    new-instance v5, Lkotlin/coroutines/experimental/migration/ContextMigration;

    invoke-direct {v5, v3}, Lkotlin/coroutines/experimental/migration/ContextMigration;-><init>(Lkotlin/coroutines/experimental/CoroutineContext;)V
    ...
    .line 54
    .restart local v4    # "result":Lkotlin/coroutines/CoroutineContext;
    :cond_2
...
.method public static final toExperimentalCoroutineContext(Lkotlin/coroutines/CoroutineContext;)Lkotlin/coroutines/experimental/CoroutineContext;
    ...
    .prologue
    const-string v5, "$this$toExperimentalCoroutineContext"
    ...
    invoke-interface {p0, v5}, Lkotlin/coroutines/CoroutineContext;->get(Lkotlin/coroutines/CoroutineContext$Key;)Lkotlin/coroutines/CoroutineContext$Element;
    ...
    sget-object v5, Lkotlin/coroutines/experimental/migration/ContextMigration;->Key:Lkotlin/coroutines/experimental/migration/ContextMigration$Key;
    ...
    invoke-interface {p0, v5}, Lkotlin/coroutines/CoroutineContext;->minusKey(Lkotlin/coroutines/CoroutineContext$Key;)Lkotlin/coroutines/CoroutineContext;
    ...
    invoke-interface {v6, v5}, Lkotlin/coroutines/CoroutineContext;->minusKey(Lkotlin/coroutines/CoroutineContext$Key;)Lkotlin/coroutines/CoroutineContext;

    move-result-object v3

    .line 39
    .local v3, "remainder":Lkotlin/coroutines/CoroutineContext;
    if-eqz v1, :cond_0
    ...
    .line 40
    .local v2, "original":Lkotlin/coroutines/experimental/CoroutineContext;
    :goto_0
    sget-object v5, Lkotlin/coroutines/EmptyCoroutineContext;->INSTANCE:Lkotlin/coroutines/EmptyCoroutineContext;
    ...
    .end local v4    # "result":Lkotlin/coroutines/experimental/CoroutineContext;
    :goto_2
    return-object v4

    .line 39
    .end local v2    # "original":Lkotlin/coroutines/experimental/CoroutineContext;
    :cond_0
    sget-object v5, Lkotlin/coroutines/experimental/EmptyCoroutineContext;->INSTANCE:Lkotlin/coroutines/experimental/EmptyCoroutineContext;
    ...
    .line 40
    .restart local v2    # "original":Lkotlin/coroutines/experimental/CoroutineContext;
    :cond_1
    new-instance v5, Lkotlin/coroutines/experimental/migration/ExperimentalContextMigration;

    invoke-direct {v5, v3}, Lkotlin/coroutines/experimental/migration/ExperimentalContextMigration;-><init>(Lkotlin/coroutines/CoroutineContext;)V

    check-cast v5, Lkotlin/coroutines/experimental/CoroutineContext;

    invoke-interface {v2, v5}, Lkotlin/coroutines/experimental/CoroutineContext;->plus(Lkotlin/coroutines/experimental/CoroutineContext;)Lkotlin/coroutines/experimental/CoroutineContext;
    ...
    .line 41
    .restart local v4    # "result":Lkotlin/coroutines/experimental/CoroutineContext;
    :cond_2
