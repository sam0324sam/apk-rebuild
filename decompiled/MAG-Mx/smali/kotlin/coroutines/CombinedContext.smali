...
.method private final size()I
    ...
    .end local v0    # "cur":Lkotlin/coroutines/CombinedContext;
    ...
    .line 74
    .restart local v0    # "cur":Lkotlin/coroutines/CombinedContext;
...
.method private final writeReplace()Ljava/lang/Object;
    ...
    .line 106
    .local v1, "n":I
    new-array v0, v1, [Lkotlin/coroutines/CoroutineContext;

    .line 107
    .local v0, "elements":[Lkotlin/coroutines/CoroutineContext;
    ...
    new-instance v2, Lkotlin/coroutines/CombinedContext$writeReplace$1;

    invoke-direct {v2, v0, v4}, Lkotlin/coroutines/CombinedContext$writeReplace$1;-><init>([Lkotlin/coroutines/CoroutineContext;Lkotlin/jvm/internal/Ref$IntRef;)V

    check-cast v2, Lkotlin/jvm/functions/Function2;

    invoke-virtual {p0, v5, v2}, Lkotlin/coroutines/CombinedContext;->fold(Ljava/lang/Object;Lkotlin/jvm/functions/Function2;)Ljava/lang/Object;
    ...
    .line 110
    :cond_1
    new-instance v2, Lkotlin/coroutines/CombinedContext$Serialized;

    invoke-direct {v2, v0}, Lkotlin/coroutines/CombinedContext$Serialized;-><init>([Lkotlin/coroutines/CoroutineContext;)V
...
.method public get(Lkotlin/coroutines/CoroutineContext$Key;)Lkotlin/coroutines/CoroutineContext$Element;
    ...
    .line 45
    .local v1, "cur":Lkotlin/coroutines/CombinedContext;
    :goto_0
    nop

    .line 46
    iget-object v4, v1, Lkotlin/coroutines/CombinedContext;->element:Lkotlin/coroutines/CoroutineContext$Element;

    invoke-interface {v4, p1}, Lkotlin/coroutines/CoroutineContext$Element;->get(Lkotlin/coroutines/CoroutineContext$Key;)Lkotlin/coroutines/CoroutineContext$Element;

    move-result-object v2

    if-eqz v2, :cond_0

    .local v2, "it":Lkotlin/coroutines/CoroutineContext$Element;
    const/4 v0, 0x0

    .line 51
    .end local v2    # "it":Lkotlin/coroutines/CoroutineContext$Element;
    :goto_1
    return-object v2

    .line 47
    :cond_0
    iget-object v3, v1, Lkotlin/coroutines/CombinedContext;->left:Lkotlin/coroutines/CoroutineContext;

    .line 48
    .local v3, "next":Lkotlin/coroutines/CoroutineContext;
    instance-of v4, v3, Lkotlin/coroutines/CombinedContext;
    ...
    .line 51
    :cond_1
    invoke-interface {v3, p1}, Lkotlin/coroutines/CoroutineContext;->get(Lkotlin/coroutines/CoroutineContext$Key;)Lkotlin/coroutines/CoroutineContext$Element;
...
.method public minusKey(Lkotlin/coroutines/CoroutineContext$Key;)Lkotlin/coroutines/CoroutineContext;
    ...
    .line 60
    iget-object v3, p0, Lkotlin/coroutines/CombinedContext;->element:Lkotlin/coroutines/CoroutineContext$Element;

    invoke-interface {v3, p1}, Lkotlin/coroutines/CoroutineContext$Element;->get(Lkotlin/coroutines/CoroutineContext$Key;)Lkotlin/coroutines/CoroutineContext$Element;
    ...
    .local v0, "$i$a$-let-CombinedContext$minusKey$1":I
    iget-object v3, p0, Lkotlin/coroutines/CombinedContext;->left:Lkotlin/coroutines/CoroutineContext;

    .line 62
    .end local v0    # "$i$a$-let-CombinedContext$minusKey$1":I
    .end local v1    # "it":Lkotlin/coroutines/CoroutineContext$Element;
    .end local p0    # "this":Lkotlin/coroutines/CombinedContext;
    :goto_0
    return-object v3

    .line 61
    .restart local p0    # "this":Lkotlin/coroutines/CombinedContext;
    :cond_0
    iget-object v3, p0, Lkotlin/coroutines/CombinedContext;->left:Lkotlin/coroutines/CoroutineContext;

    invoke-interface {v3, p1}, Lkotlin/coroutines/CoroutineContext;->minusKey(Lkotlin/coroutines/CoroutineContext$Key;)Lkotlin/coroutines/CoroutineContext;

    move-result-object v2

    .line 62
    .local v2, "newLeft":Lkotlin/coroutines/CoroutineContext;
    nop
    ...
    iget-object v4, p0, Lkotlin/coroutines/CombinedContext;->element:Lkotlin/coroutines/CoroutineContext$Element;

    invoke-direct {v3, v2, v4}, Lkotlin/coroutines/CombinedContext;-><init>(Lkotlin/coroutines/CoroutineContext;Lkotlin/coroutines/CoroutineContext$Element;)V
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0, v2, v0}, Lkotlin/coroutines/CombinedContext;->fold(Ljava/lang/Object;Lkotlin/jvm/functions/Function2;)Ljava/lang/Object;
