...
.method public static final capitalize(Ljava/lang/String;)Ljava/lang/String;
    ...
    .end local p0    # "$this$capitalize":Ljava/lang/String;
    :cond_2
    return-object p0
.end method
...
.method public static final capitalize(Ljava/lang/String;Ljava/util/Locale;)Ljava/lang/String;
    ...
    .line 583
    .local v0, "$i$a$-buildString-StringsKt__StringsJVMKt$capitalize$1":I
    invoke-static {v2}, Ljava/lang/Character;->toTitleCase(C)C

    move-result v3

    .line 584
    .local v3, "titleChar":C
    ...
    .line 593
    .end local v0    # "$i$a$-buildString-StringsKt__StringsJVMKt$capitalize$1":I
    .end local v1    # "$this$buildString":Ljava/lang/StringBuilder;
    .end local v2    # "firstChar":C
    .end local v3    # "titleChar":C
    :cond_0
    return-object p0

    .restart local p0    # "$this$capitalize":Ljava/lang/String;
    :cond_1
    move v4, v6
    ...
    .line 587
    .restart local v0    # "$i$a$-buildString-StringsKt__StringsJVMKt$capitalize$1":I
    .restart local v1    # "$this$buildString":Ljava/lang/StringBuilder;
    .restart local v2    # "firstChar":C
    .restart local v3    # "titleChar":C
    :cond_2
...
.method public static final decapitalize(Ljava/lang/String;)Ljava/lang/String;
    ...
    .end local p0    # "$this$decapitalize":Ljava/lang/String;
    :cond_2
    return-object p0
.end method
...
.method public static final decodeToString([BIIZ)Ljava/lang/String;
    ...
    .prologue
    const-string v1, "$this$decodeToString"
    ...
    invoke-virtual {v1, p1, p2, v2}, Lkotlin/collections/AbstractList$Companion;->checkBoundsIndexes$kotlin_stdlib(III)V
...
.method public static final encodeToByteArray(Ljava/lang/String;IIZ)[B
    ...
    invoke-virtual {v4, p1, p2, v5}, Lkotlin/collections/AbstractList$Companion;->checkBoundsIndexes$kotlin_stdlib(III)V
    ...
    .line 241
    .end local p0    # "$this$encodeToByteArray":Ljava/lang/String;
    :goto_0
    return-object v3

    .line 236
    .restart local p0    # "$this$encodeToByteArray":Ljava/lang/String;
    :cond_1
    ...
    invoke-virtual {v2, v4}, Ljava/nio/charset/CharsetEncoder;->encode(Ljava/nio/CharBuffer;)Ljava/nio/ByteBuffer;
    ...
    const-string v4, "byteBuffer.array()"
    ...
    .local v0, "$i$a$-also-StringsKt__StringsJVMKt$encodeToByteArray$1":I
...
.method public static final isBlank(Ljava/lang/CharSequence;)Z
    ...
    .restart local v2    # "$this$all$iv":Ljava/lang/Iterable;
    :cond_1
    ...
    .line 494
    .local v0, "$i$a$-all-StringsKt__StringsJVMKt$isBlank$1":I
    ...
    .end local v0    # "$i$a$-all-StringsKt__StringsJVMKt$isBlank$1":I
...
.method public static final repeat(Ljava/lang/CharSequence;I)Ljava/lang/String;
    ...
    .local v2, "$i$a$-require-StringsKt__StringsJVMKt$repeat$1":I
    ...
    .end local v2    # "$i$a$-require-StringsKt__StringsJVMKt$repeat$1":I
    :cond_0
    move v7, v6
    ...
    .local v1, "$i$a$-let-StringsKt__StringsJVMKt$repeat$2":I
    new-array v7, p1, [C
    ...
    .local v0, "$i$a$-<init>-StringsKt__StringsJVMKt$repeat$2$1":I
    aput-char v3, v7, v6
    ...
    .end local v0    # "$i$a$-<init>-StringsKt__StringsJVMKt$repeat$2$1":I
    :cond_2
    ...
    .line 637
    .end local v1    # "$i$a$-let-StringsKt__StringsJVMKt$repeat$2":I
    .end local v3    # "char":C
...
.method public static final replaceFirst(Ljava/lang/String;CCZ)Ljava/lang/String;
    ...
    .end local p0    # "$this$replaceFirst":Ljava/lang/String;
    :goto_0
    return-object p0

    .restart local p0    # "$this$replaceFirst":Ljava/lang/String;
    :cond_0
