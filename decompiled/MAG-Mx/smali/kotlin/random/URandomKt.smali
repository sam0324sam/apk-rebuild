...
.method public static final nextUInt-a8DCA5k(Lkotlin/random/Random;II)I
    ...
    .line 42
    .local v0, "signedFrom":I
    xor-int v2, p2, v4

    .line 44
    .local v2, "signedUntil":I
    invoke-virtual {p0, v0, v2}, Lkotlin/random/Random;->nextInt(II)I
...
.method public static final nextULong-jmpaW-c(Lkotlin/random/Random;JJ)J
    ...
    const-string v6, "$this$nextULong"
    ...
    .line 98
    .local v0, "signedFrom":J
    xor-long v4, p3, v8

    .line 100
    .local v4, "signedUntil":J
    invoke-virtual {p0, v0, v1, v4, v5}, Lkotlin/random/Random;->nextLong(JJ)J
