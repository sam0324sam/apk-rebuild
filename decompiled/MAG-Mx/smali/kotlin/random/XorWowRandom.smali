...
.method public constructor <init>(IIIIII)V
    ...
    .line 29
    iget v3, p0, Lkotlin/random/XorWowRandom;->x:I

    iget v4, p0, Lkotlin/random/XorWowRandom;->y:I

    or-int/2addr v3, v4

    iget v4, p0, Lkotlin/random/XorWowRandom;->z:I

    or-int/2addr v3, v4

    iget v4, p0, Lkotlin/random/XorWowRandom;->w:I

    or-int/2addr v3, v4

    iget v4, p0, Lkotlin/random/XorWowRandom;->v:I
    ...
    .local v1, "$i$a$-require-XorWowRandom$1":I
    const-string v4, "Initial state must have at least one non-zero element."
    ...
    .end local v1    # "$i$a$-require-XorWowRandom$1":I
    :cond_0
    move v3, v2
    ...
    .local v0, "$i$a$-repeat-XorWowRandom$2":I
    ...
    .line 33
    .end local v0    # "$i$a$-repeat-XorWowRandom$2":I
    .end local v2    # "it":I
    :cond_2
    return-void
.end method
...
.method public nextInt()I
    ...
    iput v2, p0, Lkotlin/random/XorWowRandom;->x:I

    .line 39
    iget v2, p0, Lkotlin/random/XorWowRandom;->z:I

    iput v2, p0, Lkotlin/random/XorWowRandom;->y:I
