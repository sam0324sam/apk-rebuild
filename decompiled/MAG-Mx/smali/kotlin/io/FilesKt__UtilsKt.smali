...
.method public static final copyRecursively(Ljava/io/File;Ljava/io/File;ZLkotlin/jvm/functions/Function2;)Z
    ...
    .prologue
    const-string v2, "$this$copyRecursively"
...
.method public static final copyTo(Ljava/io/File;Ljava/io/File;ZI)Ljava/io/File;
    ...
    .line 205
    .local v7, "$i$a$-use-FilesKt__UtilsKt$copyTo$1":I
    ...
    .line 206
    .local v8, "$i$a$-use-FilesKt__UtilsKt$copyTo$1$1":I
    ...
    invoke-static {v9, v10, v0}, Lkotlin/io/ByteStreamsKt;->copyTo(Ljava/io/InputStream;Ljava/io/OutputStream;I)J
    :try_end_1
    ...
    .line 209
    .end local v7    # "$i$a$-use-FilesKt__UtilsKt$copyTo$1":I
    .end local v8    # "$i$a$-use-FilesKt__UtilsKt$copyTo$1$1":I
    :cond_6
    return-object p1

    .line 205
    .restart local v7    # "$i$a$-use-FilesKt__UtilsKt$copyTo$1":I
    :catch_0
    move-exception v4
...
.method public static final deleteRecursively(Ljava/io/File;)Z
    ...
    .prologue
    const-string v6, "$this$deleteRecursively"
    ...
    .line 316
    .local v0, "$i$a$-fold-FilesKt__UtilsKt$deleteRecursively$1":I
    ...
    .local v2, "accumulator$iv":Z
    :goto_1
    goto :goto_0

    .end local v2    # "accumulator$iv":Z
    :cond_1
    const/4 v2, 0x0

    goto :goto_1

    .end local v0    # "$i$a$-fold-FilesKt__UtilsKt$deleteRecursively$1":I
    .end local v5    # "res":Z
    :cond_2
    return v2
.end method
...
.method public static final normalize(Ljava/io/File;)Ljava/io/File;
    ...
    .local v10, "$this$with":Lkotlin/io/FilePathComponents;
    const/4 v9, 0x0

    .local v9, "$i$a$-with-FilesKt__UtilsKt$normalize$1":I
    ...
    invoke-static {v11, v0}, Lkotlin/io/FilesKt;->resolve(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
...
.method public static final relativeToOrNull(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
    ...
    .prologue
    const-string v2, "$this$relativeToOrNull"
    ...
    .local v0, "$i$a$-unknown-FilesKt__UtilsKt$relativeToOrNull$1":I
    new-instance v2, Ljava/io/File;

    invoke-direct {v2, v1}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .end local v0    # "$i$a$-unknown-FilesKt__UtilsKt$relativeToOrNull$1":I
...
.method public static final relativeToOrSelf(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
    ...
    .prologue
    const-string v2, "$this$relativeToOrSelf"
    ...
    .local v0, "$i$a$-unknown-FilesKt__UtilsKt$relativeToOrSelf$1":I
    new-instance p0, Ljava/io/File;

    .end local p0    # "$this$relativeToOrSelf":Ljava/io/File;
    invoke-direct {p0, v1}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .end local v0    # "$i$a$-unknown-FilesKt__UtilsKt$relativeToOrSelf$1":I
    .end local v1    # "p1":Ljava/lang/String;
    :cond_0
    return-object p0
.end method
...
.method public static final resolveSibling(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
    ...
    .prologue
    const-string v2, "$this$resolveSibling"
...
.method private static final toRelativeStringOrNull$FilesKt__UtilsKt(Ljava/io/File;Ljava/io/File;)Ljava/lang/String;
    ...
    .line 118
    .local v20, "thisComponents":Lkotlin/io/FilePathComponents;
    ...
    .line 119
    .local v14, "baseComponents":Lkotlin/io/FilePathComponents;
    invoke-virtual/range {v20 .. v20}, Lkotlin/io/FilePathComponents;->getRoot()Ljava/io/File;
    ...
    .line 124
    .local v15, "baseCount":I
    invoke-virtual/range {v20 .. v20}, Lkotlin/io/FilePathComponents;->getSize()I

    move-result v21

    .line 126
    .local v21, "thisCount":I
    move-object/from16 v13, p0

    .local v13, "$this$countSame":Ljava/io/File;
    const/4 v12, 0x0

    .line 127
    .local v12, "$i$a$-run-FilesKt__UtilsKt$toRelativeStringOrNull$sameCount$1":I
    const/16 v16, 0x0
    ...
    invoke-virtual/range {v20 .. v20}, Lkotlin/io/FilePathComponents;->getSegments()Ljava/util/List;
