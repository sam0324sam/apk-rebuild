...
.method private static final MutableList(ILkotlin/jvm/functions/Function1;)Ljava/util/List;
    ...
    .local v0, "$i$a$-repeat-CollectionsKt__CollectionsKt$MutableList$1":I
    invoke-static {v2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;
    ...
    .line 153
    .end local v0    # "$i$a$-repeat-CollectionsKt__CollectionsKt$MutableList$1":I
...
.method public static final binarySearch(Ljava/util/List;IILkotlin/jvm/functions/Function1;)I
    ...
    .prologue
    const-string v5, "$this$binarySearch"
...
.method private static final ifEmpty(Ljava/util/Collection;Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;
    ...
    .end local p0    # "$this$ifEmpty":Ljava/util/Collection;
    :cond_0
    return-object p0
.end method
...
.method public static final optimizeReadOnlyList(Ljava/util/List;)Ljava/util/List;
    ...
    .end local p0    # "$this$optimizeReadOnlyList":Ljava/util/List;
    :goto_0
    return-object p0

    .line 229
    .restart local p0    # "$this$optimizeReadOnlyList":Ljava/util/List;
    :pswitch_0
    invoke-static {}, Lkotlin/collections/CollectionsKt;->emptyList()Ljava/util/List;
...
.method private static final orEmpty(Ljava/util/Collection;)Ljava/util/Collection;
    ...
    .end local p0    # "$this$orEmpty":Ljava/util/Collection;
    :goto_0
    return-object p0

    .restart local p0    # "$this$orEmpty":Ljava/util/Collection;
    :cond_0
    invoke-static {}, Lkotlin/collections/CollectionsKt;->emptyList()Ljava/util/List;
...
.method private static final orEmpty(Ljava/util/List;)Ljava/util/List;
    ...
    .end local p0    # "$this$orEmpty":Ljava/util/List;
    :goto_0
    return-object p0

    .restart local p0    # "$this$orEmpty":Ljava/util/List;
    :cond_0
    invoke-static {}, Lkotlin/collections/CollectionsKt;->emptyList()Ljava/util/List;
