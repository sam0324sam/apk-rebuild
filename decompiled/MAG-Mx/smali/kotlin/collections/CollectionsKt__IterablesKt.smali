...
.method public static final collectionSizeOrDefault(Ljava/lang/Iterable;I)I
    ...
    .end local p0    # "$this$collectionSizeOrDefault":Ljava/lang/Iterable;
...
.method public static final collectionSizeOrNull(Ljava/lang/Iterable;)Ljava/lang/Integer;
    ...
    .end local p0    # "$this$collectionSizeOrNull":Ljava/lang/Iterable;
    invoke-interface {p0}, Ljava/util/Collection;->size()I
    ...
    .restart local p0    # "$this$collectionSizeOrNull":Ljava/lang/Iterable;
    :cond_0
    const/4 v0, 0x0
...
.method public static final convertToSetForSetOperation(Ljava/lang/Iterable;)Ljava/util/Collection;
    ...
    .line 58
    .end local p0    # "$this$convertToSetForSetOperation":Ljava/lang/Iterable;
    :goto_0
    return-object p0

    .line 60
    .restart local p0    # "$this$convertToSetForSetOperation":Ljava/lang/Iterable;
    :cond_0
    instance-of v0, p0, Ljava/util/Collection;
...
.method public static final convertToSetForSetOperationWith(Ljava/lang/Iterable;Ljava/lang/Iterable;)Ljava/util/Collection;
    ...
    .line 46
    .end local p0    # "$this$convertToSetForSetOperationWith":Ljava/lang/Iterable;
    :goto_0
    return-object p0

    .line 48
    .restart local p0    # "$this$convertToSetForSetOperationWith":Ljava/lang/Iterable;
    :cond_0
    instance-of v0, p0, Ljava/util/Collection;
