...
.method public static final getOrPut(Ljava/util/concurrent/ConcurrentMap;Ljava/lang/Object;Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;
    ...
    .local v0, "$i$a$-let-MapsKt__MapsJVMKt$getOrPut$1":I
...
.method public static final varargs sortedMapOf([Lkotlin/Pair;)Ljava/util/SortedMap;
    ...
    .local v0, "$i$a$-apply-MapsKt__MapsJVMKt$sortedMapOf$1":I
    move-object v2, v1
...
.method private static final toProperties(Ljava/util/Map;)Ljava/util/Properties;
    ...
    .local v0, "$i$a$-apply-MapsKt__MapsJVMKt$toProperties$1":I
...
.method public static final toSingletonMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    .prologue
    const-string v2, "$this$toSingletonMap"
    ...
    .local v1, "$this$with":Ljava/util/Map$Entry;
    const/4 v0, 0x0

    .local v0, "$i$a$-with-MapsKt__MapsJVMKt$toSingletonMap$1":I
    ...
    const-string v3, "with(entries.iterator().\u2026ingletonMap(key, value) }"
...
.method public static final toSortedMap(Ljava/util/Map;Ljava/util/Comparator;)Ljava/util/SortedMap;
    ...
    .prologue
    const-string v2, "$this$toSortedMap"
    ...
    .local v0, "$i$a$-apply-MapsKt__MapsJVMKt$toSortedMap$1":I
