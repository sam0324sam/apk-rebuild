...
.method private getSQLiteQuery(II)Landroidx/room/RoomSQLiteQuery;
    ...
    .line 188
    .local p0, "this":Landroidx/room/paging/LimitOffsetDataSource;, "Landroidx/room/paging/LimitOffsetDataSource<TT;>;"
    iget-object v1, p0, Landroidx/room/paging/LimitOffsetDataSource;->mLimitOffsetQuery:Ljava/lang/String;

    iget-object v2, p0, Landroidx/room/paging/LimitOffsetDataSource;->mSourceQuery:Landroidx/room/RoomSQLiteQuery;

    .line 189
    invoke-virtual {v2}, Landroidx/room/RoomSQLiteQuery;->getArgCount()I
...
.method public countItems()I
    ...
    .line 84
    iget-object v3, p0, Landroidx/room/paging/LimitOffsetDataSource;->mCountQuery:Ljava/lang/String;

    iget-object v4, p0, Landroidx/room/paging/LimitOffsetDataSource;->mSourceQuery:Landroidx/room/RoomSQLiteQuery;
    ...
    iget-object v3, p0, Landroidx/room/paging/LimitOffsetDataSource;->mSourceQuery:Landroidx/room/RoomSQLiteQuery;

    invoke-virtual {v1, v3}, Landroidx/room/RoomSQLiteQuery;->copyArgumentsFrom(Landroidx/room/RoomSQLiteQuery;)V
...
.method public loadInitial(Landroidx/paging/PositionalDataSource$LoadInitialParams;Landroidx/paging/PositionalDataSource$LoadInitialCallback;)V
    ...
    .line 116
    .local v5, "sqLiteQuery":Landroidx/room/RoomSQLiteQuery;
    const/4 v0, 0x0
    ...
    .line 122
    invoke-static {p1, v6}, Landroidx/room/paging/LimitOffsetDataSource;->computeInitialLoadPosition(Landroidx/paging/PositionalDataSource$LoadInitialParams;I)I

    move-result v1

    .line 123
    invoke-static {p1, v1, v6}, Landroidx/room/paging/LimitOffsetDataSource;->computeInitialLoadSize(Landroidx/paging/PositionalDataSource$LoadInitialParams;II)I

    move-result v2

    .line 125
    .local v2, "firstLoadSize":I
    invoke-direct {p0, v1, v2}, Landroidx/room/paging/LimitOffsetDataSource;->getSQLiteQuery(II)Landroidx/room/RoomSQLiteQuery;
    ...
    invoke-virtual {v7, v5}, Landroidx/room/RoomDatabase;->query(Landroidx/sqlite/db/SupportSQLiteQuery;)Landroid/database/Cursor;
    ...
    .line 128
    .local v4, "rows":Ljava/util/List;, "Ljava/util/List<TT;>;"
    iget-object v7, p0, Landroidx/room/paging/LimitOffsetDataSource;->mDb:Landroidx/room/RoomDatabase;
    ...
    .line 132
    .end local v2    # "firstLoadSize":I
    .end local v4    # "rows":Ljava/util/List;, "Ljava/util/List<TT;>;"
    :cond_0
    if-eqz v0, :cond_1
    ...
    .line 141
    :cond_2
    invoke-virtual {p2, v3, v1, v6}, Landroidx/paging/PositionalDataSource$LoadInitialCallback;->onResult(Ljava/util/List;II)V
    ...
    .line 135
    :cond_3
    iget-object v8, p0, Landroidx/room/paging/LimitOffsetDataSource;->mDb:Landroidx/room/RoomDatabase;
...
.method public loadRange(II)Ljava/util/List;
    ...
    iget-boolean v3, p0, Landroidx/room/paging/LimitOffsetDataSource;->mInTransaction:Z
