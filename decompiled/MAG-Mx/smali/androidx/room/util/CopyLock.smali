...
.method private static getThreadLock(Ljava/lang/String;)Ljava/util/concurrent/locks/Lock;
    ...
    .line 105
    .local v0, "threadLock":Ljava/util/concurrent/locks/Lock;
    if-nez v0, :cond_0

    .line 106
    new-instance v0, Ljava/util/concurrent/locks/ReentrantLock;

    .end local v0    # "threadLock":Ljava/util/concurrent/locks/Lock;
    invoke-direct {v0}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    .line 107
    .restart local v0    # "threadLock":Ljava/util/concurrent/locks/Lock;
    sget-object v1, Landroidx/room/util/CopyLock;->sThreadLocks:Ljava/util/Map;
...
.method public lock()V
    ...
    .prologue
    .line 79
    iget-object v1, p0, Landroidx/room/util/CopyLock;->mThreadLock:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v1}, Ljava/util/concurrent/locks/Lock;->lock()V

    .line 80
    iget-boolean v1, p0, Landroidx/room/util/CopyLock;->mFileLevelLock:Z
    ...
    iget-object v2, p0, Landroidx/room/util/CopyLock;->mCopyLockFile:Ljava/io/File;
    ...
    iput-object v1, p0, Landroidx/room/util/CopyLock;->mLockChannel:Ljava/nio/channels/FileChannel;

    .line 83
    iget-object v1, p0, Landroidx/room/util/CopyLock;->mLockChannel:Ljava/nio/channels/FileChannel;
