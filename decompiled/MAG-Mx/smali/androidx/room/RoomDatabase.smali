...
.method public close()V
    ...
    .line 243
    iget-object v1, p0, Landroidx/room/RoomDatabase;->mCloseLock:Ljava/util/concurrent/locks/ReentrantReadWriteLock;
...
.method public init(Landroidx/room/DatabaseConfiguration;)V
    ...
    iput-object v2, p0, Landroidx/room/RoomDatabase;->mOpenHelper:Landroidx/sqlite/db/SupportSQLiteOpenHelper;

    .line 162
    iget-object v2, p0, Landroidx/room/RoomDatabase;->mOpenHelper:Landroidx/sqlite/db/SupportSQLiteOpenHelper;

    instance-of v2, v2, Landroidx/room/SQLiteCopyOpenHelper;
    ...
    iput-object v2, p0, Landroidx/room/RoomDatabase;->mCallbacks:Ljava/util/List;

    .line 172
    iget-object v2, p1, Landroidx/room/DatabaseConfiguration;->queryExecutor:Ljava/util/concurrent/Executor;

    iput-object v2, p0, Landroidx/room/RoomDatabase;->mQueryExecutor:Ljava/util/concurrent/Executor;
    ...
    invoke-direct {v2, v3}, Landroidx/room/TransactionExecutor;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object v2, p0, Landroidx/room/RoomDatabase;->mTransactionExecutor:Ljava/util/concurrent/Executor;

    .line 174
    iget-boolean v2, p1, Landroidx/room/DatabaseConfiguration;->allowMainThreadQueries:Z

    iput-boolean v2, p0, Landroidx/room/RoomDatabase;->mAllowMainThreadQueries:Z

    .line 175
    iput-boolean v1, p0, Landroidx/room/RoomDatabase;->mWriteAheadLoggingEnabled:Z

    .line 176
    iget-boolean v2, p1, Landroidx/room/DatabaseConfiguration;->multiInstanceInvalidation:Z

    if-eqz v2, :cond_2

    .line 177
    iget-object v2, p0, Landroidx/room/RoomDatabase;->mInvalidationTracker:Landroidx/room/InvalidationTracker;
    ...
    invoke-virtual {v2, v3, v4}, Landroidx/room/InvalidationTracker;->startMultiInstanceInvalidation(Landroid/content/Context;Ljava/lang/String;)V
