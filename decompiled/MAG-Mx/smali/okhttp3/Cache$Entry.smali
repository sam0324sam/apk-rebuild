...
.method public constructor <init>(Lokio/Source;)V
    ...
    invoke-interface {v12}, Lokio/BufferedSource;->readUtf8LineStrict()Ljava/lang/String;
    ...
    .line 493
    new-instance v16, Lokhttp3/Headers$Builder;

    invoke-direct/range {v16 .. v16}, Lokhttp3/Headers$Builder;-><init>()V

    .line 494
    .local v16, "varyHeadersBuilder":Lokhttp3/Headers$Builder;
    sget-object v18, Lokhttp3/Cache;->Companion:Lokhttp3/Cache$Companion;

    move-object/from16 v0, v18

    invoke-virtual {v0, v12}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lokio/BufferedSource;)I

    move-result v17

    .line 495
    .local v17, "varyRequestHeaderLineCount":I
    const/4 v5, 0x0
    ...
    .end local v5    # "i":I
    :cond_0
    invoke-virtual/range {v16 .. v16}, Lokhttp3/Headers$Builder;->build()Lokhttp3/Headers;
    ...
    .line 500
    sget-object v18, Lokhttp3/internal/http/StatusLine;->Companion:Lokhttp3/internal/http/StatusLine$Companion;

    invoke-interface {v12}, Lokio/BufferedSource;->readUtf8LineStrict()Ljava/lang/String;

    move-result-object v19

    invoke-virtual/range {v18 .. v19}, Lokhttp3/internal/http/StatusLine$Companion;->parse(Ljava/lang/String;)Lokhttp3/internal/http/StatusLine;

    move-result-object v13

    .line 501
    .local v13, "statusLine":Lokhttp3/internal/http/StatusLine;
    iget-object v0, v13, Lokhttp3/internal/http/StatusLine;->protocol:Lokhttp3/Protocol;
    ...
    .line 502
    iget v0, v13, Lokhttp3/internal/http/StatusLine;->code:I
    ...
    .line 503
    iget-object v0, v13, Lokhttp3/internal/http/StatusLine;->message:Ljava/lang/String;
    ...
    invoke-virtual {v10, v0}, Lokhttp3/Headers$Builder;->addLenient$okhttp(Ljava/lang/String;)Lokhttp3/Headers$Builder;
    ...
    .end local v5    # "i":I
    :cond_1
    sget-object v18, Lokhttp3/Cache$Entry;->SENT_MILLIS:Ljava/lang/String;

    move-object/from16 v0, v18

    invoke-virtual {v10, v0}, Lokhttp3/Headers$Builder;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v11

    .line 510
    .local v11, "sendRequestMillisString":Ljava/lang/String;
    sget-object v18, Lokhttp3/Cache$Entry;->RECEIVED_MILLIS:Ljava/lang/String;
    ...
    invoke-virtual {v10, v0}, Lokhttp3/Headers$Builder;->removeAll(Ljava/lang/String;)Lokhttp3/Headers$Builder;
    ...
    .local v14, "this":Lokhttp3/Cache$Entry;
    :goto_2
    move-wide/from16 v0, v18

    iput-wide v0, v14, Lokhttp3/Cache$Entry;->sentRequestMillis:J
    ...
    iput-wide v0, v14, Lokhttp3/Cache$Entry;->receivedResponseMillis:J
    ...
    const-string v20, "expected \"\" but was \""
    ...
    .end local v13    # "statusLine":Lokhttp3/internal/http/StatusLine;
    .end local v14    # "this":Lokhttp3/Cache$Entry;
    .end local v16    # "varyHeadersBuilder":Lokhttp3/Headers$Builder;
    .end local v17    # "varyRequestHeaderLineCount":I
    :catchall_0
    move-exception v18
    ...
    .line 513
    .restart local v8    # "receivedResponseMillisString":Ljava/lang/String;
    .restart local v9    # "responseHeaderLineCount":I
    .restart local v10    # "responseHeadersBuilder":Lokhttp3/Headers$Builder;
    .restart local v11    # "sendRequestMillisString":Ljava/lang/String;
    .restart local v12    # "source":Lokio/BufferedSource;
    .restart local v13    # "statusLine":Lokhttp3/internal/http/StatusLine;
    .restart local v16    # "varyHeadersBuilder":Lokhttp3/Headers$Builder;
    .restart local v17    # "varyRequestHeaderLineCount":I
    ...
    .end local p0    # "this":Lokhttp3/Cache$Entry;
    .restart local v14    # "this":Lokhttp3/Cache$Entry;
    goto :goto_2
    ...
    .line 523
    .local v4, "cipherSuiteString":Ljava/lang/String;
    sget-object v18, Lokhttp3/CipherSuite;->Companion:Lokhttp3/CipherSuite$Companion;

    move-object/from16 v0, v18

    invoke-virtual {v0, v4}, Lokhttp3/CipherSuite$Companion;->forJavaName(Ljava/lang/String;)Lokhttp3/CipherSuite;

    move-result-object v3

    .line 524
    .local v3, "cipherSuite":Lokhttp3/CipherSuite;
    move-object/from16 v0, p0

    invoke-direct {v0, v12}, Lokhttp3/Cache$Entry;->readCertificateList(Lokio/BufferedSource;)Ljava/util/List;

    move-result-object v7

    .line 525
    .local v7, "peerCertificates":Ljava/util/List;
    move-object/from16 v0, p0
    ...
    .line 526
    .local v6, "localCertificates":Ljava/util/List;
    ...
    .line 527
    sget-object v18, Lokhttp3/TlsVersion;->Companion:Lokhttp3/TlsVersion$Companion;

    invoke-interface {v12}, Lokio/BufferedSource;->readUtf8LineStrict()Ljava/lang/String;

    move-result-object v19

    invoke-virtual/range {v18 .. v19}, Lokhttp3/TlsVersion$Companion;->forJavaName(Ljava/lang/String;)Lokhttp3/TlsVersion;
    ...
    :goto_5
    sget-object v18, Lokhttp3/Handshake;->Companion:Lokhttp3/Handshake$Companion;

    move-object/from16 v0, v18

    invoke-virtual {v0, v15, v3, v7, v6}, Lokhttp3/Handshake$Companion;->get(Lokhttp3/TlsVersion;Lokhttp3/CipherSuite;Ljava/util/List;Ljava/util/List;)Lokhttp3/Handshake;
    ...
    .line 534
    .end local v2    # "blank":Ljava/lang/String;
    .end local v3    # "cipherSuite":Lokhttp3/CipherSuite;
    .end local v4    # "cipherSuiteString":Ljava/lang/String;
    .end local v6    # "localCertificates":Ljava/util/List;
    .end local v7    # "peerCertificates":Ljava/util/List;
    ...
    .line 529
    .restart local v2    # "blank":Ljava/lang/String;
    .restart local v3    # "cipherSuite":Lokhttp3/CipherSuite;
    .restart local v4    # "cipherSuiteString":Ljava/lang/String;
    .restart local v6    # "localCertificates":Ljava/util/List;
    .restart local v7    # "peerCertificates":Ljava/util/List;
    :cond_6
    :try_start_2
    ...
    check-cast v18, Lokhttp3/Handshake;
...
.method private final readCertificateList(Lokio/BufferedSource;)Ljava/util/List;
    ...
    invoke-virtual {v7, p1}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lokio/BufferedSource;)I
...
.method public final response(Lokhttp3/internal/cache/DiskLruCache$Snapshot;)Lokhttp3/Response;
    ...
    invoke-direct {v3, p1, v2, v1}, Lokhttp3/Cache$CacheResponseBody;-><init>(Lokhttp3/internal/cache/DiskLruCache$Snapshot;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    .line 555
    invoke-virtual {p1, v2}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)Lokio/Sink;
    ...
    .line 585
    iget-object v2, p0, Lokhttp3/Cache$Entry;->handshake:Lokhttp3/Handshake;
    ...
    invoke-virtual {v2}, Lokhttp3/CipherSuite;->javaName()Ljava/lang/String;
    ...
    invoke-direct {p0, v1, v2}, Lokhttp3/Cache$Entry;->writeCertList(Lokio/BufferedSink;Ljava/util/List;)V
