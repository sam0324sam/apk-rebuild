...
.method public close()V
    ...
    iput-boolean v2, p0, Lokhttp3/ResponseBody$BomAwareReader;->closed:Z

    .line 217
    iget-object v2, p0, Lokhttp3/ResponseBody$BomAwareReader;->delegate:Ljava/io/Reader;
    ...
    .line 217
    check-cast v1, Lokhttp3/ResponseBody$BomAwareReader;

    .local v1, "$this$run":Lokhttp3/ResponseBody$BomAwareReader;
    const/4 v0, 0x0

    .local v0, "$i$a$-run-ResponseBody$BomAwareReader$close$1":I
    iget-object v2, v1, Lokhttp3/ResponseBody$BomAwareReader;->source:Lokio/BufferedSource;
...
.method public read([CII)I
    ...
    .line 211
    .local v1, "finalDelegate":Ljava/io/Reader;
    :goto_0
    ...
    .line 208
    .end local v1    # "finalDelegate":Ljava/io/Reader;
    :cond_1
    ...
    iget-object v5, p0, Lokhttp3/ResponseBody$BomAwareReader;->charset:Ljava/nio/charset/Charset;

    invoke-static {v4, v5}, Lokhttp3/internal/Util;->readBomAsCharset(Lokio/BufferedSource;Ljava/nio/charset/Charset;)Ljava/nio/charset/Charset;
    ...
    .local v0, "$i$a$-also-ResponseBody$BomAwareReader$read$finalDelegate$1":I
    move-object v3, v2
