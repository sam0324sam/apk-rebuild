...
.method public final run()V
    ...
    .prologue
    .line 390
    iget-object v8, p0, Lokhttp3/internal/http2/Http2Connection$pushDataLater$$inlined$execute$1;->$name:Ljava/lang/String;
    ...
    :try_start_0
    iget-object v10, p0, Lokhttp3/internal/http2/Http2Connection$pushDataLater$$inlined$execute$1;->this$0:Lokhttp3/internal/http2/Http2Connection;
    ...
    iget v12, p0, Lokhttp3/internal/http2/Http2Connection$pushDataLater$$inlined$execute$1;->$streamId$inlined:I

    iget-object v10, p0, Lokhttp3/internal/http2/Http2Connection$pushDataLater$$inlined$execute$1;->$buffer$inlined:Lokio/Buffer;

    check-cast v10, Lokio/BufferedSource;

    iget v13, p0, Lokhttp3/internal/http2/Http2Connection$pushDataLater$$inlined$execute$1;->$byteCount$inlined:I

    iget-boolean v14, p0, Lokhttp3/internal/http2/Http2Connection$pushDataLater$$inlined$execute$1;->$inFinished$inlined:Z

    invoke-interface {v11, v12, v10, v13, v14}, Lokhttp3/internal/http2/PushObserver;->onData(ILokio/BufferedSource;IZ)Z
    ...
    iget v11, p0, Lokhttp3/internal/http2/Http2Connection$pushDataLater$$inlined$execute$1;->$streamId$inlined:I
    ...
    iget-boolean v10, p0, Lokhttp3/internal/http2/Http2Connection$pushDataLater$$inlined$execute$1;->$inFinished$inlined:Z

    if-eqz v10, :cond_2

    .line 585
    :cond_1
    iget-object v11, p0, Lokhttp3/internal/http2/Http2Connection$pushDataLater$$inlined$execute$1;->this$0:Lokhttp3/internal/http2/Http2Connection;
    ...
    .line 586
    .local v2, "$i$a$-synchronized-Http2Connection$pushDataLater$1$1$1":I
    :try_start_1
    iget-object v10, p0, Lokhttp3/internal/http2/Http2Connection$pushDataLater$$inlined$execute$1;->this$0:Lokhttp3/internal/http2/Http2Connection;
    ...
    .line 589
    .end local v2    # "$i$a$-synchronized-Http2Connection$pushDataLater$1$1$1":I
    :cond_2
    nop
    ...
    .line 585
    .restart local v2    # "$i$a$-synchronized-Http2Connection$pushDataLater$1$1$1":I
