...
.method private final emitFrame(Z)V
    ...
    .line 538
    .local v6, "$i$a$-synchronized-Http2Stream$FramingSink$emitFrame$1":I
    :try_start_0
    ...
    invoke-virtual {v0, v8, v9}, Lokhttp3/internal/http2/Http2Stream;->setWriteBytesTotal$okhttp(J)V
...
.method public close()V
    ...
    .line 582
    .local v6, "$i$a$-synchronized-Http2Stream$FramingSink$close$1":I
    :try_start_0
    iget-boolean v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSink;->closed:Z
    :try_end_0
    ...
    .line 595
    .restart local v9    # "hasTrailers":Z
    :cond_5
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSink;->this$0:Lokhttp3/internal/http2/Http2Stream;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lokhttp3/internal/http2/Http2Connection;->writeHeaders$okhttp(IZLjava/util/List;)V
    ...
    .line 610
    .local v7, "$i$a$-synchronized-Http2Stream$FramingSink$close$2":I
    const/4 v0, 0x1
    ...
    .line 598
    .end local v7    # "$i$a$-synchronized-Http2Stream$FramingSink$close$2":I
    .restart local v8    # "hasData":Z
    .restart local v9    # "hasTrailers":Z
    :cond_8
    if-eqz v8, :cond_9
    ...
    .end local v8    # "hasData":Z
    .end local v9    # "hasTrailers":Z
    .restart local v7    # "$i$a$-synchronized-Http2Stream$FramingSink$close$2":I
    :catchall_1
    move-exception v0
...
.method public flush()V
    ...
    .line 568
    .local v0, "$i$a$-synchronized-Http2Stream$FramingSink$flush$1":I
    :try_start_0
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSink;->this$0:Lokhttp3/internal/http2/Http2Stream;
