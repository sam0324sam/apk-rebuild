...
.method static constructor <clinit>()V
    ...
    sget-object v2, Lokhttp3/internal/http2/Huffman;->CODE_BIT_COUNTS:[B
    ...
    invoke-direct {v1, v0, v3, v4}, Lokhttp3/internal/http2/Huffman;->addCode(III)V
...
.method private final addCode(III)V
    ...
    invoke-direct {v8, p1, p3}, Lokhttp3/internal/http2/Huffman$Node;-><init>(II)V

    .line 161
    .local v8, "terminal":Lokhttp3/internal/http2/Huffman$Node;
    move v0, p3

    .line 162
    .local v0, "accumulatorBitCount":I
    sget-object v5, Lokhttp3/internal/http2/Huffman;->root:Lokhttp3/internal/http2/Huffman$Node;

    .line 163
    .local v5, "node":Lokhttp3/internal/http2/Huffman$Node;
    :goto_0
    const/16 v9, 0x8
    ...
    invoke-virtual {v5}, Lokhttp3/internal/http2/Huffman$Node;->getChildren()[Lokhttp3/internal/http2/Huffman$Node;
    ...
    .line 167
    .local v3, "children":[Lokhttp3/internal/http2/Huffman$Node;
    :cond_0
    aget-object v1, v3, v2

    .line 168
    .local v1, "child":Lokhttp3/internal/http2/Huffman$Node;
    if-nez v1, :cond_1

    .line 169
    new-instance v1, Lokhttp3/internal/http2/Huffman$Node;

    .end local v1    # "child":Lokhttp3/internal/http2/Huffman$Node;
    invoke-direct {v1}, Lokhttp3/internal/http2/Huffman$Node;-><init>()V

    .line 170
    .restart local v1    # "child":Lokhttp3/internal/http2/Huffman$Node;
    ...
    .end local v3    # "children":[Lokhttp3/internal/http2/Huffman$Node;
    :cond_2
    ...
    invoke-static {v9, v8, v7, v10}, Lkotlin/collections/ArraysKt;->fill([Ljava/lang/Object;Ljava/lang/Object;II)V
...
.method public final decode(Lokio/BufferedSource;JLokio/BufferedSink;)V
    ...
    .line 125
    .local v4, "node":Lokhttp3/internal/http2/Huffman$Node;
    const/4 v0, 0x0
    ...
    invoke-static {v5, v8}, Lokhttp3/internal/Util;->and(BI)I
    ...
    .end local v4    # "node":Lokhttp3/internal/http2/Huffman$Node;
    if-nez v4, :cond_1

    invoke-static {}, Lkotlin/jvm/internal/Intrinsics;->throwNpe()V

    .line 134
    .restart local v4    # "node":Lokhttp3/internal/http2/Huffman$Node;
    :cond_1
    invoke-virtual {v4}, Lokhttp3/internal/http2/Huffman$Node;->getChildren()[Lokhttp3/internal/http2/Huffman$Node;
...
.method public final encode(Lokio/ByteString;Lokio/BufferedSink;)V
    ...
    invoke-static {v8, v9}, Lokhttp3/internal/Util;->and(BI)I
