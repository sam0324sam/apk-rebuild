...
.method public final run()V
    ...
    .prologue
    .line 390
    iget-object v8, p0, Lokhttp3/internal/http2/Http2Connection$pushHeadersLater$$inlined$tryExecute$1;->$name:Ljava/lang/String;
    ...
    .line 579
    .local v3, "$i$a$-tryExecute-Http2Connection$pushHeadersLater$1":I
    :try_start_0
    iget-object v10, p0, Lokhttp3/internal/http2/Http2Connection$pushHeadersLater$$inlined$tryExecute$1;->this$0:Lokhttp3/internal/http2/Http2Connection;
    ...
    iget v11, p0, Lokhttp3/internal/http2/Http2Connection$pushHeadersLater$$inlined$tryExecute$1;->$streamId$inlined:I

    iget-object v12, p0, Lokhttp3/internal/http2/Http2Connection$pushHeadersLater$$inlined$tryExecute$1;->$requestHeaders$inlined:Ljava/util/List;

    iget-boolean v13, p0, Lokhttp3/internal/http2/Http2Connection$pushHeadersLater$$inlined$tryExecute$1;->$inFinished$inlined:Z

    invoke-interface {v10, v11, v12, v13}, Lokhttp3/internal/http2/PushObserver;->onHeaders(ILjava/util/List;Z)Z
    :try_end_0
    ...
    .line 583
    .local v0, "$i$a$-ignoreIoExceptions-Http2Connection$pushHeadersLater$1$1":I
    if-eqz v6, :cond_0
    ...
    iget-boolean v10, p0, Lokhttp3/internal/http2/Http2Connection$pushHeadersLater$$inlined$tryExecute$1;->$inFinished$inlined:Z

    if-eqz v10, :cond_2

    .line 585
    :cond_1
    iget-object v11, p0, Lokhttp3/internal/http2/Http2Connection$pushHeadersLater$$inlined$tryExecute$1;->this$0:Lokhttp3/internal/http2/Http2Connection;
    ...
    .line 586
    .local v1, "$i$a$-synchronized-Http2Connection$pushHeadersLater$1$1$1":I
    :try_start_2
    iget-object v10, p0, Lokhttp3/internal/http2/Http2Connection$pushHeadersLater$$inlined$tryExecute$1;->this$0:Lokhttp3/internal/http2/Http2Connection;
    ...
    iget v12, p0, Lokhttp3/internal/http2/Http2Connection$pushHeadersLater$$inlined$tryExecute$1;->$streamId$inlined:I
    ...
    .line 591
    .end local v1    # "$i$a$-synchronized-Http2Connection$pushHeadersLater$1$1$1":I
    :cond_2
    :goto_0
    nop
    ...
    .line 585
    .restart local v1    # "$i$a$-synchronized-Http2Connection$pushHeadersLater$1$1$1":I
    :catchall_0
    move-exception v10
    ...
    .line 577
    .end local v0    # "$i$a$-ignoreIoExceptions-Http2Connection$pushHeadersLater$1$1":I
