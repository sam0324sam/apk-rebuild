...
.method public deleteContents(Ljava/io/File;)V
    ...
    .line 98
    invoke-virtual {p0, v0}, Lokhttp3/internal/io/FileSystem$Companion$SYSTEM$1;->deleteContents(Ljava/io/File;)V
...
.method public sink(Ljava/io/File;)Lokio/Sink;
    ...
    :try_start_0
    invoke-static {p1, v1, v2, v3}, Lokio/Okio;->sink$default(Ljava/io/File;ZILjava/lang/Object;)Lokio/Sink;
    :try_end_0
    .catch Ljava/io/FileNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 58
    invoke-static {p1, v4, v5, v6}, Lokio/Okio;->sink$default(Ljava/io/File;ZILjava/lang/Object;)Lokio/Sink;
