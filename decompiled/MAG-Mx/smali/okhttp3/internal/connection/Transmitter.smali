...
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/Call;)V
    ...
    iput-object v2, p0, Lokhttp3/internal/connection/Transmitter;->connectionPool:Lokhttp3/internal/connection/RealConnectionPool;
    ...
    iget-object v3, p0, Lokhttp3/internal/connection/Transmitter;->call:Lokhttp3/Call;

    invoke-interface {v2, v3}, Lokhttp3/EventListener$Factory;->create(Lokhttp3/Call;)Lokhttp3/EventListener;

    move-result-object v2

    iput-object v2, p0, Lokhttp3/internal/connection/Transmitter;->eventListener:Lokhttp3/EventListener;

    .line 55
    new-instance v1, Lokhttp3/internal/connection/Transmitter$timeout$1;

    invoke-direct {v1, p0}, Lokhttp3/internal/connection/Transmitter$timeout$1;-><init>(Lokhttp3/internal/connection/Transmitter;)V

    .line 59
    .local v1, "$this$apply":Lokhttp3/internal/connection/Transmitter$timeout$1;
    const/4 v0, 0x0

    .line 60
    .local v0, "$i$a$-apply-Transmitter$timeout$2":I
    iget-object v2, p0, Lokhttp3/internal/connection/Transmitter;->client:Lokhttp3/OkHttpClient;
    ...
    invoke-virtual {v1, v2, v3, v4}, Lokhttp3/internal/connection/Transmitter$timeout$1;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/Timeout;

    .line 61
    nop

    .line 59
    iput-object v1, p0, Lokhttp3/internal/connection/Transmitter;->timeout:Lokhttp3/internal/connection/Transmitter$timeout$1;
...
.method private final createAddress(Lokhttp3/HttpUrl;)Lokhttp3/Address;
    ...
    .line 140
    check-cast v7, Lokhttp3/CertificatePinner;
...
.method private final maybeReleaseConnection(Ljava/io/IOException;Z)Ljava/io/IOException;
    ...
    .line 271
    .local v5, "result":Ljava/io/IOException;
    const/4 v6, 0x0
    ...
    .line 273
    .local v4, "releasedConnection":Lkotlin/jvm/internal/Ref$ObjectRef;
    const/4 v2, 0x0

    .line 274
    .local v2, "callEnd":Z
    iget-object v10, p0, Lokhttp3/internal/connection/Transmitter;->connectionPool:Lokhttp3/internal/connection/RealConnectionPool;
    ...
    .line 275
    .local v1, "$i$a$-synchronized-Transmitter$maybeReleaseConnection$1":I
    if-eqz p2, :cond_0

    :try_start_0
    iget-object v7, p0, Lokhttp3/internal/connection/Transmitter;->exchange:Lokhttp3/internal/connection/Exchange;
    ...
    .local v0, "$i$a$-check-Transmitter$maybeReleaseConnection$1$1":I
    const-string v8, "cannot release connection while it is in use"
    ...
    .line 274
    .end local v0    # "$i$a$-check-Transmitter$maybeReleaseConnection$1$1":I
    :catchall_0
    move-exception v7
    ...
    :cond_2
    :try_start_1
    iget-object v7, p0, Lokhttp3/internal/connection/Transmitter;->connection:Lokhttp3/internal/connection/RealConnection;
    ...
    iget-boolean v7, p0, Lokhttp3/internal/connection/Transmitter;->noMoreExchanges:Z
    ...
    .line 288
    iget-object v9, p0, Lokhttp3/internal/connection/Transmitter;->eventListener:Lokhttp3/EventListener;

    iget-object v10, p0, Lokhttp3/internal/connection/Transmitter;->call:Lokhttp3/Call;
    ...
    :cond_6
    invoke-virtual {v9, v10, v7}, Lokhttp3/EventListener;->connectionReleased(Lokhttp3/Call;Lokhttp3/Connection;)V
    ...
    .line 293
    .local v3, "callFailed":Z
    :goto_3
    invoke-direct {p0, v5}, Lokhttp3/internal/connection/Transmitter;->timeoutExit(Ljava/io/IOException;)Ljava/io/IOException;
    ...
    iget-object v8, p0, Lokhttp3/internal/connection/Transmitter;->call:Lokhttp3/Call;
    ...
    :cond_8
    invoke-virtual {v7, v8, v5}, Lokhttp3/EventListener;->callFailed(Lokhttp3/Call;Ljava/io/IOException;)V

    .line 298
    .end local v3    # "callFailed":Z
    :cond_9
    :goto_4
    return-object v5
    ...
    .line 297
    .restart local v3    # "callFailed":Z
    :cond_d
    iget-object v7, p0, Lokhttp3/internal/connection/Transmitter;->eventListener:Lokhttp3/EventListener;

    iget-object v8, p0, Lokhttp3/internal/connection/Transmitter;->call:Lokhttp3/Call;

    invoke-virtual {v7, v8}, Lokhttp3/EventListener;->callEnd(Lokhttp3/Call;)V
...
.method private final timeoutExit(Ljava/io/IOException;)Ljava/io/IOException;
    ...
    .prologue
    .line 101
    iget-boolean v1, p0, Lokhttp3/internal/connection/Transmitter;->timeoutEarlyExit:Z
    ...
    :cond_1
    iget-object v1, p0, Lokhttp3/internal/connection/Transmitter;->timeout:Lokhttp3/internal/connection/Transmitter$timeout$1;

    invoke-virtual {v1}, Lokhttp3/internal/connection/Transmitter$timeout$1;->exit()Z
...
.method public final cancel()V
    ...
    .line 324
    .local v2, "exchangeToCancel":Lokhttp3/internal/connection/Exchange;
    const/4 v1, 0x0
    ...
    .line 326
    .local v0, "$i$a$-synchronized-Transmitter$cancel$1":I
    const/4 v3, 0x1

    :try_start_0
    iput-boolean v3, p0, Lokhttp3/internal/connection/Transmitter;->canceled:Z

    .line 327
    iget-object v2, p0, Lokhttp3/internal/connection/Transmitter;->exchange:Lokhttp3/internal/connection/Exchange;

    .line 328
    iget-object v3, p0, Lokhttp3/internal/connection/Transmitter;->exchangeFinder:Lokhttp3/internal/connection/ExchangeFinder;

    if-eqz v3, :cond_1

    invoke-virtual {v3}, Lokhttp3/internal/connection/ExchangeFinder;->connectingConnection()Lokhttp3/internal/connection/RealConnection;
...
.method public final exchangeDoneDueToException()V
    ...
    .line 207
    .local v0, "$i$a$-synchronized-Transmitter$exchangeDoneDueToException$1":I
    :try_start_0
...
.method public final exchangeMessageDone$okhttp(Lokhttp3/internal/connection/Exchange;ZZLjava/io/IOException;)Ljava/io/IOException;
    ...
    .line 227
    .local v3, "result":Ljava/io/IOException;
    const/4 v2, 0x0

    .line 228
    .local v2, "exchangeDone":Z
    iget-object v6, p0, Lokhttp3/internal/connection/Transmitter;->connectionPool:Lokhttp3/internal/connection/RealConnectionPool;
    ...
    .line 229
    .local v0, "$i$a$-synchronized-Transmitter$exchangeMessageDone$1":I
    :try_start_0
    ...
    .line 250
    .end local v3    # "result":Ljava/io/IOException;
    .local v4, "result":Ljava/io/IOException;
    :goto_0
    return-object v4

    .line 232
    .end local v4    # "result":Ljava/io/IOException;
    .restart local v3    # "result":Ljava/io/IOException;
    :cond_0
    const/4 v1, 0x0
    ...
    :cond_6
    invoke-virtual {v5}, Lokhttp3/internal/connection/RealConnection;->getSuccessCount$okhttp()I

    move-result v7

    add-int/lit8 v7, v7, 0x1

    invoke-virtual {v5, v7}, Lokhttp3/internal/connection/RealConnection;->setSuccessCount$okhttp(I)V
    ...
    iput-object v5, p0, Lokhttp3/internal/connection/Transmitter;->exchange:Lokhttp3/internal/connection/Exchange;
    ...
    invoke-direct {p0, v3, v5}, Lokhttp3/internal/connection/Transmitter;->maybeReleaseConnection(Ljava/io/IOException;Z)Ljava/io/IOException;
    ...
    .line 250
    .end local v3    # "result":Ljava/io/IOException;
    .restart local v4    # "result":Ljava/io/IOException;
    goto :goto_0
...
.method public final hasExchange()Z
    ...
    .line 309
    .local v0, "$i$a$-synchronized-Transmitter$hasExchange$1":I
    :try_start_0
...
.method public final isCanceled()Z
    ...
    .line 80
    .local v0, "$i$a$-synchronized-Transmitter$isCanceled$1":I
    :try_start_0
    iget-boolean v2, p0, Lokhttp3/internal/connection/Transmitter;->canceled:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final newExchange$okhttp(Lokhttp3/Interceptor$Chain;Z)Lokhttp3/internal/connection/Exchange;
    ...
    .line 155
    .local v8, "$i$a$-synchronized-Transmitter$newExchange$1":I
    :try_start_0
    ...
    .local v6, "$i$a$-check-Transmitter$newExchange$1$1":I
    ...
    .line 154
    .end local v6    # "$i$a$-check-Transmitter$newExchange$1$1":I
    :catchall_0
    move-exception v1
    ...
    .line 157
    .local v7, "$i$a$-check-Transmitter$newExchange$1$2":I
    ...
    .end local v7    # "$i$a$-check-Transmitter$newExchange$1$2":I
    :cond_2
    move v1, v2
    ...
    invoke-virtual {v1, v2, p1, p2}, Lokhttp3/internal/connection/ExchangeFinder;->find(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;Z)Lokhttp3/internal/http/ExchangeCodec;

    move-result-object v5

    .line 163
    .local v5, "codec":Lokhttp3/internal/http/ExchangeCodec;
    ...
    .line 165
    .local v0, "result":Lokhttp3/internal/connection/Exchange;
    iget-object v2, p0, Lokhttp3/internal/connection/Transmitter;->connectionPool:Lokhttp3/internal/connection/RealConnectionPool;
    ...
    .line 166
    .local v9, "$i$a$-synchronized-Transmitter$newExchange$2":I
    :try_start_2
...
.method public final noMoreExchanges(Ljava/io/IOException;)Ljava/io/IOException;
    ...
    .line 255
    .local v0, "$i$a$-synchronized-Transmitter$noMoreExchanges$1":I
    const/4 v1, 0x1
    ...
    invoke-direct {p0, p1, v1}, Lokhttp3/internal/connection/Transmitter;->maybeReleaseConnection(Ljava/io/IOException;Z)Ljava/io/IOException;
...
.method public final releaseConnectionNoEvents()Ljava/net/Socket;
    ...
    .line 186
    iget-object v8, p0, Lokhttp3/internal/connection/Transmitter;->connectionPool:Lokhttp3/internal/connection/RealConnectionPool;
    ...
    .line 188
    :cond_0
    iget-object v8, p0, Lokhttp3/internal/connection/Transmitter;->connection:Lokhttp3/internal/connection/RealConnection;
    ...
    :cond_1
    invoke-virtual {v8}, Lokhttp3/internal/connection/RealConnection;->getTransmitters()Ljava/util/List;
    ...
    .local v5, "it":Ljava/lang/ref/Reference;
    const/4 v0, 0x0

    .line 188
    .local v0, "$i$a$-indexOfFirst-Transmitter$releaseConnectionNoEvents$index$1":I
    invoke-virtual {v5}, Ljava/lang/ref/Reference;->get()Ljava/lang/Object;

    move-result-object v8

    check-cast v8, Lokhttp3/internal/connection/Transmitter;

    move-object v9, p0

    check-cast v9, Lokhttp3/internal/connection/Transmitter;
    ...
    .line 189
    .end local v0    # "$i$a$-indexOfFirst-Transmitter$releaseConnectionNoEvents$index$1":I
    .end local v5    # "it":Ljava/lang/ref/Reference;
    ...
    .restart local v0    # "$i$a$-indexOfFirst-Transmitter$releaseConnectionNoEvents$index$1":I
    .restart local v5    # "it":Ljava/lang/ref/Reference;
    ...
    .line 192
    .local v7, "released":Lokhttp3/internal/connection/RealConnection;
    if-nez v7, :cond_6

    invoke-static {}, Lkotlin/jvm/internal/Intrinsics;->throwNpe()V

    :cond_6
    invoke-virtual {v7}, Lokhttp3/internal/connection/RealConnection;->getTransmitters()Ljava/util/List;
    ...
    iput-object v8, p0, Lokhttp3/internal/connection/Transmitter;->connection:Lokhttp3/internal/connection/RealConnection;
    ...
    invoke-virtual {v7, v8, v9}, Lokhttp3/internal/connection/RealConnection;->setIdleAtNanos$okhttp(J)V

    .line 197
    iget-object v8, p0, Lokhttp3/internal/connection/Transmitter;->connectionPool:Lokhttp3/internal/connection/RealConnectionPool;

    invoke-virtual {v8, v7}, Lokhttp3/internal/connection/RealConnectionPool;->connectionBecameIdle(Lokhttp3/internal/connection/RealConnection;)Z
