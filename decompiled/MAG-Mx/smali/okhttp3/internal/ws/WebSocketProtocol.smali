...
.method public final toggleMask(Lokio/Buffer$UnsafeCursor;[B)V
    ...
    :cond_0
    iget-object v0, p1, Lokio/Buffer$UnsafeCursor;->data:[B
    ...
    .line 104
    .local v3, "i":I
    iget v2, p1, Lokio/Buffer$UnsafeCursor;->end:I
    ...
    .line 119
    .end local v1    # "bufferInt":I
    .end local v5    # "keyInt":I
    :cond_1
...
.method public final validateCloseCode(I)V
    ...
    .local v0, "$i$a$-require-WebSocketProtocol$validateCloseCode$1":I
    if-nez v1, :cond_0
    ...
    .end local v0    # "$i$a$-require-WebSocketProtocol$validateCloseCode$1":I
    :cond_1
    const/4 v2, 0x0
