...
.method public final addFormDataPart(Ljava/lang/String;Ljava/lang/String;)Lokhttp3/MultipartBody$Builder;
    ...
    .line 256
    check-cast v1, Lokhttp3/MultipartBody$Builder;

    .local v1, "$this$apply":Lokhttp3/MultipartBody$Builder;
    const/4 v0, 0x0

    .line 257
    .local v0, "$i$a$-apply-MultipartBody$Builder$addFormDataPart$1":I
    ...
    invoke-virtual {v1, v2}, Lokhttp3/MultipartBody$Builder;->addPart(Lokhttp3/MultipartBody$Part;)Lokhttp3/MultipartBody$Builder;
    ...
    .line 258
    .end local p0    # "this":Lokhttp3/MultipartBody$Builder;
    return-object p0
.end method
...
.method public final addFormDataPart(Ljava/lang/String;Ljava/lang/String;Lokhttp3/RequestBody;)Lokhttp3/MultipartBody$Builder;
    ...
    .line 262
    .local v0, "$i$a$-apply-MultipartBody$Builder$addFormDataPart$2":I
    sget-object v2, Lokhttp3/MultipartBody$Part;->Companion:Lokhttp3/MultipartBody$Part$Companion;
...
.method public final addPart(Lokhttp3/Headers;Lokhttp3/RequestBody;)Lokhttp3/MultipartBody$Builder;
    ...
    .line 252
    .local v0, "$i$a$-apply-MultipartBody$Builder$addPart$2":I
    sget-object v2, Lokhttp3/MultipartBody$Part;->Companion:Lokhttp3/MultipartBody$Part$Companion;
...
.method public final addPart(Lokhttp3/MultipartBody$Part;)Lokhttp3/MultipartBody$Builder;
    ...
    .line 267
    .local v0, "$i$a$-apply-MultipartBody$Builder$addPart$3":I
    iget-object v2, v1, Lokhttp3/MultipartBody$Builder;->parts:Ljava/util/List;
...
.method public final addPart(Lokhttp3/RequestBody;)Lokhttp3/MultipartBody$Builder;
    ...
    .line 247
    .local v0, "$i$a$-apply-MultipartBody$Builder$addPart$1":I
    sget-object v2, Lokhttp3/MultipartBody$Part;->Companion:Lokhttp3/MultipartBody$Part$Companion;
...
.method public final build()Lokhttp3/MultipartBody;
    ...
    .prologue
    .line 272
    iget-object v1, p0, Lokhttp3/MultipartBody$Builder;->parts:Ljava/util/List;
    ...
    invoke-direct {v1, v2, v3, v4}, Lokhttp3/MultipartBody;-><init>(Lokio/ByteString;Lokhttp3/MediaType;Ljava/util/List;)V
...
.method public final setType(Lokhttp3/MediaType;)Lokhttp3/MultipartBody$Builder;
    ...
    .line 240
    check-cast v2, Lokhttp3/MultipartBody$Builder;

    .local v2, "$this$apply":Lokhttp3/MultipartBody$Builder;
    const/4 v0, 0x0

    .line 241
    .local v0, "$i$a$-apply-MultipartBody$Builder$setType$1":I
    ...
    .local v1, "$i$a$-require-MultipartBody$Builder$setType$1$1":I
    ...
    .line 242
    .end local v1    # "$i$a$-require-MultipartBody$Builder$setType$1$1":I
    :cond_0
