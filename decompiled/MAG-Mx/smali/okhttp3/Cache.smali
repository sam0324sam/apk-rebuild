...
.method public final get$okhttp(Lokhttp3/Request;)Lokhttp3/Response;
    ...
    invoke-virtual {v5, v7}, Lokhttp3/Cache$Companion;->key(Lokhttp3/HttpUrl;)Ljava/lang/String;
    ...
    invoke-virtual {v5, v2}, Lokhttp3/internal/cache/DiskLruCache;->get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v4, v5}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;->getSource(I)Lokio/Source;

    move-result-object v5

    invoke-direct {v1, v5}, Lokhttp3/Cache$Entry;-><init>(Lokio/Source;)V
    :try_end_1
    ...
    .line 172
    .restart local v0    # "_":Ljava/io/IOException;
...
.method public final put$okhttp(Lokhttp3/Response;)Lokhttp3/internal/cache/CacheRequest;
    ...
    invoke-direct {v8, p1}, Lokhttp3/Cache$Entry;-><init>(Lokhttp3/Response;)V

    .local v8, "entry":Lokhttp3/Cache$Entry;
    move-object v7, v10

    .line 208
    check-cast v7, Lokhttp3/internal/cache/DiskLruCache$Editor;

    .line 209
    .local v7, "editor":Lokhttp3/internal/cache/DiskLruCache$Editor;
    nop
    ...
    .end local v7    # "editor":Lokhttp3/internal/cache/DiskLruCache$Editor;
    if-eqz v7, :cond_0

    .line 211
    .restart local v7    # "editor":Lokhttp3/internal/cache/DiskLruCache$Editor;
    invoke-virtual {v8, v7}, Lokhttp3/Cache$Entry;->writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V

    .line 212
    new-instance v0, Lokhttp3/Cache$RealCacheRequest;

    invoke-direct {v0, p0, v7}, Lokhttp3/Cache$RealCacheRequest;-><init>(Lokhttp3/Cache;Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    invoke-direct {p0, v7}, Lokhttp3/Cache;->abortQuietly(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    .end local v7    # "editor":Lokhttp3/internal/cache/DiskLruCache$Editor;
    .end local v8    # "entry":Lokhttp3/Cache$Entry;
    :catch_1
    move-exception v0
...
.method public final update$okhttp(Lokhttp3/Response;Lokhttp3/Response;)V
    ...
    invoke-virtual {v4}, Lokhttp3/Cache$CacheResponseBody;->getSnapshot$okhttp()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
