...
.method protected subscribeActual(Lio/reactivex/SingleObserver;)V
    ...
    .line 36
    iget-object v9, p0, Lio/reactivex/internal/operators/single/SingleAmb;->sources:[Lio/reactivex/SingleSource;

    .line 37
    .local v9, "sources":[Lio/reactivex/SingleSource;, "[Lio/reactivex/SingleSource<+TT;>;"
    const/4 v1, 0x0
    ...
    new-array v9, v10, [Lio/reactivex/SingleSource;

    .line 41
    :try_start_0
    iget-object v10, p0, Lio/reactivex/internal/operators/single/SingleAmb;->sourcesIterable:Ljava/lang/Iterable;
    ...
    invoke-static {v10, p1}, Lio/reactivex/internal/disposables/EmptyDisposable;->error(Ljava/lang/Throwable;Lio/reactivex/SingleObserver;)V
    ...
    invoke-static {v9, v11, v0, v12, v2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    :try_end_1
    ...
    .line 64
    .local v7, "set":Lio/reactivex/disposables/CompositeDisposable;
    new-instance v8, Lio/reactivex/internal/operators/single/SingleAmb$AmbSingleObserver;

    invoke-direct {v8, p1, v7}, Lio/reactivex/internal/operators/single/SingleAmb$AmbSingleObserver;-><init>(Lio/reactivex/SingleObserver;Lio/reactivex/disposables/CompositeDisposable;)V

    .line 65
    .local v8, "shared":Lio/reactivex/internal/operators/single/SingleAmb$AmbSingleObserver;, "Lio/reactivex/internal/operators/single/SingleAmb$AmbSingleObserver<TT;>;"
    ...
    invoke-virtual {v8}, Lio/reactivex/internal/operators/single/SingleAmb$AmbSingleObserver;->get()Z
    ...
    .line 74
    invoke-virtual {v7}, Lio/reactivex/disposables/CompositeDisposable;->dispose()V
    ...
    invoke-virtual {v8, v13, v10}, Lio/reactivex/internal/operators/single/SingleAmb$AmbSingleObserver;->compareAndSet(ZZ)Z
    ...
    .end local v7    # "set":Lio/reactivex/disposables/CompositeDisposable;
    .end local v8    # "shared":Lio/reactivex/internal/operators/single/SingleAmb$AmbSingleObserver;, "Lio/reactivex/internal/operators/single/SingleAmb$AmbSingleObserver<TT;>;"
    :catch_0
    move-exception v3
    ...
    .restart local v6    # "s1":Lio/reactivex/SingleSource;, "Lio/reactivex/SingleSource<+TT;>;"
    .restart local v7    # "set":Lio/reactivex/disposables/CompositeDisposable;
    .restart local v8    # "shared":Lio/reactivex/internal/operators/single/SingleAmb$AmbSingleObserver;, "Lio/reactivex/internal/operators/single/SingleAmb$AmbSingleObserver<TT;>;"
    :cond_5
    ...
    .end local v3    # "e":Ljava/lang/Throwable;
    :cond_6
    invoke-interface {v6, v8}, Lio/reactivex/SingleSource;->subscribe(Lio/reactivex/SingleObserver;)V
