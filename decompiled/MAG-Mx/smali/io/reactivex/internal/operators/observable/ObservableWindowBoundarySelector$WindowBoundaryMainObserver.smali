...
.method drainLoop()V
    ...
    iget-object v10, v0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowBoundaryMainObserver;->queue:Lio/reactivex/internal/fuseable/SimplePlainQueue;

    check-cast v10, Lio/reactivex/internal/queue/MpscLinkedQueue;
    ...
    iget-object v13, v0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowBoundaryMainObserver;->ws:Ljava/util/List;
    ...
    .line 191
    .local v4, "d":Z
    invoke-virtual {v10}, Lio/reactivex/internal/queue/MpscLinkedQueue;->poll()Ljava/lang/Object;
    ...
    invoke-virtual {v11, v5}, Lio/reactivex/subjects/UnicastSubject;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0, v14}, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowBoundaryMainObserver;->leave(I)I
    ...
    .line 215
    :cond_5
    instance-of v14, v8, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowOperation;
    ...
    .line 217
    check-cast v12, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowOperation;

    .line 219
    .local v12, "wo":Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowOperation;, "Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowOperation<TT;TB;>;"
    iget-object v11, v12, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowOperation;->w:Lio/reactivex/subjects/UnicastSubject;
    ...
    .line 221
    iget-object v14, v12, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowOperation;->w:Lio/reactivex/subjects/UnicastSubject;
    ...
    iget-object v14, v0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowBoundaryMainObserver;->windows:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iget-boolean v14, v0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowBoundaryMainObserver;->cancelled:Z
    ...
    iget v14, v0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowBoundaryMainObserver;->bufferSize:I
    ...
    iget-object v14, v0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowBoundaryMainObserver;->close:Lio/reactivex/functions/Function;

    iget-object v15, v12, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowOperation;->open:Ljava/lang/Object;

    invoke-interface {v14, v15}, Lio/reactivex/functions/Function;->apply(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v14

    const-string v15, "The ObservableSource supplied is null"
    ...
    .line 253
    .local v9, "p":Lio/reactivex/ObservableSource;, "Lio/reactivex/ObservableSource<TV;>;"
    ...
    invoke-direct {v3, v0, v11}, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$OperatorWindowBoundaryCloseObserver;-><init>(Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowBoundaryMainObserver;Lio/reactivex/subjects/UnicastSubject;)V
    ...
    iget-object v14, v0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowBoundaryMainObserver;->resources:Lio/reactivex/disposables/CompositeDisposable;

    invoke-virtual {v14, v3}, Lio/reactivex/disposables/CompositeDisposable;->add(Lio/reactivex/disposables/Disposable;)Z
    ...
    .line 258
    invoke-interface {v9, v3}, Lio/reactivex/ObservableSource;->subscribe(Lio/reactivex/Observer;)V
    ...
    .end local v9    # "p":Lio/reactivex/ObservableSource;, "Lio/reactivex/ObservableSource<TV;>;"
    :catch_0
    move-exception v5
    ...
    iput-boolean v14, v0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowBoundaryMainObserver;->cancelled:Z
    ...
    .end local v5    # "e":Ljava/lang/Throwable;
    .end local v11    # "w":Lio/reactivex/subjects/UnicastSubject;, "Lio/reactivex/subjects/UnicastSubject<TT;>;"
    .end local v12    # "wo":Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowOperation;, "Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowOperation<TT;TB;>;"
    :cond_7
    invoke-interface {v13}, Ljava/util/List;->iterator()Ljava/util/Iterator;
    ...
    invoke-virtual {v11, v15}, Lio/reactivex/subjects/UnicastSubject;->onNext(Ljava/lang/Object;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 106
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowBoundaryMainObserver;->ws:Ljava/util/List;
    ...
    .line 113
    :cond_2
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySelector$WindowBoundaryMainObserver;->queue:Lio/reactivex/internal/fuseable/SimplePlainQueue;
