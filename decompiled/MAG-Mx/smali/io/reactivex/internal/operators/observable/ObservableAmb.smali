...
.method public subscribeActual(Lio/reactivex/Observer;)V
    ...
    .line 37
    .local v6, "sources":[Lio/reactivex/ObservableSource;, "[Lio/reactivex/ObservableSource<+TT;>;"
    const/4 v2, 0x0
    ...
    new-array v6, v7, [Lio/reactivex/Observable;

    .line 41
    :try_start_0
    iget-object v7, p0, Lio/reactivex/internal/operators/observable/ObservableAmb;->sourcesIterable:Ljava/lang/Iterable;
    ...
    .line 42
    .local v5, "p":Lio/reactivex/ObservableSource;, "Lio/reactivex/ObservableSource<+TT;>;"
    if-nez v5, :cond_0
    ...
    invoke-static {v7, p1}, Lio/reactivex/internal/disposables/EmptyDisposable;->error(Ljava/lang/Throwable;Lio/reactivex/Observer;)V

    move v2, v3

    .line 73
    .end local v3    # "count":I
    .end local v5    # "p":Lio/reactivex/ObservableSource;, "Lio/reactivex/ObservableSource<+TT;>;"
    ...
    .restart local v5    # "p":Lio/reactivex/ObservableSource;, "Lio/reactivex/ObservableSource<+TT;>;"
    :cond_0
    array-length v8, v6
    ...
    invoke-interface {v7, p1}, Lio/reactivex/ObservableSource;->subscribe(Lio/reactivex/Observer;)V
