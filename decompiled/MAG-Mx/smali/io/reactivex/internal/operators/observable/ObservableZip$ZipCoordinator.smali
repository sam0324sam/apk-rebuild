...
.method cancelSources()V
    ...
    .line 137
    .local v0, "zs":Lio/reactivex/internal/operators/observable/ObservableZip$ZipObserver;, "Lio/reactivex/internal/operators/observable/ObservableZip$ZipObserver<**>;"
    invoke-virtual {v0}, Lio/reactivex/internal/operators/observable/ObservableZip$ZipObserver;->dispose()V
    ...
    .line 139
    .end local v0    # "zs":Lio/reactivex/internal/operators/observable/ObservableZip$ZipObserver;, "Lio/reactivex/internal/operators/observable/ObservableZip$ZipObserver<**>;"
    :cond_0
    return-void
.end method
...
.method clear()V
    ...
    .line 143
    .local v0, "zs":Lio/reactivex/internal/operators/observable/ObservableZip$ZipObserver;, "Lio/reactivex/internal/operators/observable/ObservableZip$ZipObserver<**>;"
    iget-object v4, v0, Lio/reactivex/internal/operators/observable/ObservableZip$ZipObserver;->queue:Lio/reactivex/internal/queue/SpscLinkedArrayQueue;
...
.method public drain()V
    ...
    iget-object v14, v0, Lio/reactivex/internal/operators/observable/ObservableZip$ZipCoordinator;->observers:[Lio/reactivex/internal/operators/observable/ObservableZip$ZipObserver;

    .line 155
    .local v14, "zs":[Lio/reactivex/internal/operators/observable/ObservableZip$ZipObserver;, "[Lio/reactivex/internal/operators/observable/ObservableZip$ZipObserver<TT;TR;>;"
    move-object/from16 v0, p0
    ...
    iget-object v11, v0, Lio/reactivex/internal/operators/observable/ObservableZip$ZipCoordinator;->row:[Ljava/lang/Object;

    .line 157
    .local v11, "os":[Ljava/lang/Object;, "[TT;"
    move-object/from16 v0, p0
    ...
    .line 180
    iget-object v8, v6, Lio/reactivex/internal/operators/observable/ObservableZip$ZipObserver;->error:Ljava/lang/Throwable;
    ...
    .line 183
    invoke-interface {v4, v8}, Lio/reactivex/Observer;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v1, v15}, Lio/reactivex/functions/Function;->apply(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    const-string v15, "The zipper returned a null value"

    invoke-static {v1, v15}, Lio/reactivex/internal/functions/ObjectHelper;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    :try_end_0
    ...
    invoke-interface {v4, v12}, Lio/reactivex/Observer;->onNext(Ljava/lang/Object;)V
