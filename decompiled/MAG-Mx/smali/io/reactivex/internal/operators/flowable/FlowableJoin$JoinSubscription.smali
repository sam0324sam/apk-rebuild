...
.method drain()V
    ...
    .line 178
    .local v18, "q":Lio/reactivex/internal/queue/SpscLinkedArrayQueue;, "Lio/reactivex/internal/queue/SpscLinkedArrayQueue<Ljava/lang/Object;>;"
    move-object/from16 v0, p0
    ...
    .line 183
    invoke-virtual/range {v18 .. v18}, Lio/reactivex/internal/queue/SpscLinkedArrayQueue;->clear()V
    ...
    .local v5, "d":Z
    :goto_2
    invoke-virtual/range {v18 .. v18}, Lio/reactivex/internal/queue/SpscLinkedArrayQueue;->poll()Ljava/lang/Object;
    ...
    .line 199
    .local v15, "mode":Ljava/lang/Integer;
    if-nez v15, :cond_5
    ...
    invoke-virtual/range {v24 .. v24}, Lio/reactivex/disposables/CompositeDisposable;->dispose()V
    ...
    .end local v15    # "mode":Ljava/lang/Integer;
    :cond_4
    const/4 v5, 0x0
    ...
    .restart local v15    # "mode":Ljava/lang/Integer;
    :cond_5
    const/4 v8, 0x0
    ...
    sget-object v24, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->LEFT_VALUE:Ljava/lang/Integer;
    ...
    iget v12, v0, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->leftIndex:I
    ...
    const-string v25, "The leftEnd returned a null Publisher"

    invoke-static/range {v24 .. v25}, Lio/reactivex/internal/functions/ObjectHelper;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 233
    .local v16, "p":Lorg/reactivestreams/Publisher;, "Lorg/reactivestreams/Publisher<TTLeftEnd;>;"
    ...
    invoke-direct {v9, v0, v1, v12}, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$LeftRightEndSubscriber;-><init>(Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$JoinSupport;ZI)V
    ...
    .end local v16    # "p":Lorg/reactivestreams/Publisher;, "Lorg/reactivestreams/Publisher<TTLeftEnd;>;"
    :catch_0
    move-exception v11
    ...
    .restart local v16    # "p":Lorg/reactivestreams/Publisher;, "Lorg/reactivestreams/Publisher<TTLeftEnd;>;"
    :cond_8
    move-object/from16 v0, p0
    ...
    .line 254
    .local v19, "right":Ljava/lang/Object;, "TTRight;"
    :try_start_1
    move-object/from16 v0, p0
    ...
    invoke-interface {v0, v13, v1}, Lio/reactivex/functions/BiFunction;->apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 265
    .end local v11    # "exc":Ljava/lang/Throwable;
    .restart local v23    # "w":Ljava/lang/Object;, "TR;"
    :cond_9
    move-object/from16 v0, p0
    ...
    new-instance v25, Lio/reactivex/exceptions/MissingBackpressureException;

    const-string v26, "Could not emit value due to lack of requests"

    invoke-direct/range {v25 .. v26}, Lio/reactivex/exceptions/MissingBackpressureException;-><init>(Ljava/lang/String;)V

    invoke-static/range {v24 .. v25}, Lio/reactivex/internal/util/ExceptionHelper;->addThrowable(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Throwable;)Z
    ...
    .line 273
    .end local v19    # "right":Ljava/lang/Object;, "TTRight;"
    .end local v23    # "w":Ljava/lang/Object;, "TR;"
    :cond_a
    ...
    .end local v20    # "r":J
    :cond_b
    sget-object v24, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->RIGHT_VALUE:Ljava/lang/Integer;
    ...
    .line 281
    .restart local v19    # "right":Ljava/lang/Object;, "TTRight;"
    move-object/from16 v0, p0

    iget v12, v0, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->rightIndex:I
    ...
    const-string v25, "The rightEnd returned a null Publisher"
    ...
    .line 294
    .local v17, "p":Lorg/reactivestreams/Publisher;, "Lorg/reactivestreams/Publisher<TTRightEnd;>;"
    new-instance v9, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$LeftRightEndSubscriber;
    ...
    .line 289
    .end local v9    # "end":Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$LeftRightEndSubscriber;
    .end local v17    # "p":Lorg/reactivestreams/Publisher;, "Lorg/reactivestreams/Publisher<TTRightEnd;>;"
    :catch_2
    move-exception v11
    ...
    .end local v11    # "exc":Ljava/lang/Throwable;
    .restart local v9    # "end":Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$LeftRightEndSubscriber;
    .restart local v17    # "p":Lorg/reactivestreams/Publisher;, "Lorg/reactivestreams/Publisher<TTRightEnd;>;"
    :cond_c
    move-object/from16 v0, p0
    ...
    .end local v20    # "r":J
    :cond_f
    sget-object v24, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->LEFT_CLOSE:Ljava/lang/Integer;
    ...
    .end local v9    # "end":Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$LeftRightEndSubscriber;
    :cond_10
    sget-object v24, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->RIGHT_CLOSE:Ljava/lang/Integer;
