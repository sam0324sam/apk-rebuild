...
.method drain()V
    ...
    check-cast v18, Lio/reactivex/processors/UnicastProcessor;

    .line 223
    .local v18, "up":Lio/reactivex/processors/UnicastProcessor;, "Lio/reactivex/processors/UnicastProcessor<*>;"
    ...
    .end local v18    # "up":Lio/reactivex/processors/UnicastProcessor;, "Lio/reactivex/processors/UnicastProcessor<*>;"
    :cond_4
    const/4 v5, 0x0
    ...
    sget-object v22, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$GroupJoinSubscription;->LEFT_VALUE:Ljava/lang/Integer;
    ...
    .line 245
    .local v19, "up":Lio/reactivex/processors/UnicastProcessor;, "Lio/reactivex/processors/UnicastProcessor<TTRight;>;"
    move-object/from16 v0, p0

    iget v10, v0, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$GroupJoinSubscription;->leftIndex:I
    ...
    const-string v23, "The leftEnd returned a null Publisher"
    ...
    invoke-direct {v7, v0, v1, v10}, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$LeftRightEndSubscriber;-><init>(Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$JoinSupport;ZI)V
    ...
    .line 284
    .end local v9    # "exc":Ljava/lang/Throwable;
    .restart local v21    # "w":Ljava/lang/Object;, "TR;"
    :cond_a
    new-instance v22, Lio/reactivex/exceptions/MissingBackpressureException;

    const-string v23, "Could not emit value due to lack of requests"

    invoke-direct/range {v22 .. v23}, Lio/reactivex/exceptions/MissingBackpressureException;-><init>(Ljava/lang/String;)V
    ...
    .end local v14    # "p":Lorg/reactivestreams/Publisher;, "Lorg/reactivestreams/Publisher<TTLeftEnd;>;"
    .end local v19    # "up":Lio/reactivex/processors/UnicastProcessor;, "Lio/reactivex/processors/UnicastProcessor<TTRight;>;"
    .end local v21    # "w":Ljava/lang/Object;, "TR;"
    :cond_b
    sget-object v22, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$GroupJoinSubscription;->RIGHT_VALUE:Ljava/lang/Integer;
    ...
    iget v10, v0, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$GroupJoinSubscription;->rightIndex:I
    ...
    const-string v23, "The rightEnd returned a null Publisher"
    ...
    .line 309
    .local v15, "p":Lorg/reactivestreams/Publisher;, "Lorg/reactivestreams/Publisher<TTRightEnd;>;"
    new-instance v7, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$LeftRightEndSubscriber;
    ...
    .line 304
    .end local v7    # "end":Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$LeftRightEndSubscriber;
    .end local v15    # "p":Lorg/reactivestreams/Publisher;, "Lorg/reactivestreams/Publisher<TTRightEnd;>;"
    :catch_2
    move-exception v9
    ...
    .end local v9    # "exc":Ljava/lang/Throwable;
    .restart local v7    # "end":Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$LeftRightEndSubscriber;
    .restart local v15    # "p":Lorg/reactivestreams/Publisher;, "Lorg/reactivestreams/Publisher<TTRightEnd;>;"
    :cond_c
    move-object/from16 v0, p0
    ...
    .line 323
    .restart local v19    # "up":Lio/reactivex/processors/UnicastProcessor;, "Lio/reactivex/processors/UnicastProcessor<TTRight;>;"
    move-object/from16 v0, v19
    ...
    .end local v19    # "up":Lio/reactivex/processors/UnicastProcessor;, "Lio/reactivex/processors/UnicastProcessor<TTRight;>;"
    :cond_d
    sget-object v22, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$GroupJoinSubscription;->LEFT_CLOSE:Ljava/lang/Integer;
    ...
    .end local v19    # "up":Lio/reactivex/processors/UnicastProcessor;, "Lio/reactivex/processors/UnicastProcessor<TTRight;>;"
    :cond_e
    sget-object v22, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$GroupJoinSubscription;->RIGHT_CLOSE:Ljava/lang/Integer;
...
.method errorAll(Lorg/reactivestreams/Subscriber;)V
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$GroupJoinSubscription;->error:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 174
    .local v1, "up":Lio/reactivex/processors/UnicastProcessor;, "Lio/reactivex/processors/UnicastProcessor<TTRight;>;"
    invoke-virtual {v1, v0}, Lio/reactivex/processors/UnicastProcessor;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    .line 177
    .end local v1    # "up":Lio/reactivex/processors/UnicastProcessor;, "Lio/reactivex/processors/UnicastProcessor<TTRight;>;"
    :cond_0
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$GroupJoinSubscription;->lefts:Ljava/util/Map;
