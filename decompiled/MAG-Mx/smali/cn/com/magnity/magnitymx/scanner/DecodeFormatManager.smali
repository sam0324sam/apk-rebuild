.class final Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->COMMA_PATTERN:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->QR_CODE_FORMATS:Ljava/util/Set;
    ...
    sput-object v0, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->DATA_MATRIX_FORMATS:Ljava/util/Set;
    ...
    sput-object v0, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->AZTEC_FORMATS:Ljava/util/Set;
    ...
    sput-object v0, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->PDF417_FORMATS:Ljava/util/Set;
    ...
    sput-object v0, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->PRODUCT_FORMATS:Ljava/util/Set;
    ...
    sput-object v0, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->INDUSTRIAL_FORMATS:Ljava/util/Set;

    .line 38
    sget-object v0, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->PRODUCT_FORMATS:Ljava/util/Set;

    invoke-static {v0}, Ljava/util/EnumSet;->copyOf(Ljava/util/Collection;)Ljava/util/EnumSet;

    move-result-object v0

    sput-object v0, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->ONE_D_FORMATS:Ljava/util/Set;

    .line 39
    sget-object v0, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->ONE_D_FORMATS:Ljava/util/Set;

    sget-object v1, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->INDUSTRIAL_FORMATS:Ljava/util/Set;
    ...
    sput-object v0, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->FORMATS_FOR_MODE:Ljava/util/Map;

    .line 44
    sget-object v0, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->FORMATS_FOR_MODE:Ljava/util/Map;

    const-string v1, "ONE_D_MODE"

    sget-object v2, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->ONE_D_FORMATS:Ljava/util/Set;
    ...
    sget-object v2, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->AZTEC_FORMATS:Ljava/util/Set;
    ...
    sget-object v2, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->PDF417_FORMATS:Ljava/util/Set;
...
.method static parseDecodeFormats(Landroid/content/Intent;)Ljava/util/Set;
    ...
    .line 58
    sget-object v2, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->COMMA_PATTERN:Ljava/util/regex/Pattern;
    ...
    invoke-static {v0, v2}, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->parseDecodeFormats(Ljava/lang/Iterable;Ljava/lang/String;)Ljava/util/Set;
...
.method static parseDecodeFormats(Landroid/net/Uri;)Ljava/util/Set;
    ...
    invoke-static {v0, v1}, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->parseDecodeFormats(Ljava/lang/Iterable;Ljava/lang/String;)Ljava/util/Set;
...
.method private static parseDecodeFormats(Ljava/lang/Iterable;Ljava/lang/String;)Ljava/util/Set;
    ...
    .line 84
    sget-object v2, Lcn/com/magnity/magnitymx/scanner/DecodeFormatManager;->FORMATS_FOR_MODE:Ljava/util/Map;
