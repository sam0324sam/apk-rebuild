...
.method parseAppender(Ljava/util/Properties;Ljava/lang/String;)Lorg/apache/log4j/Appender;
    ...
    const-string v17, "\" was already parsed."
    ...
    invoke-static/range {v16 .. v16}, Lorg/apache/log4j/helpers/LogLog;->debug(Ljava/lang/String;)V
    ...
    const-string v17, "log4j.appender."
    ...
    .line 785
    .local v14, "layoutPrefix":Ljava/lang/String;
    sget-object v16, Lorg/apache/log4j/PropertyConfigurator;->class$org$apache$log4j$Appender:Ljava/lang/Class;

    if-nez v16, :cond_1

    const-string v16, "org.apache.log4j.Appender"

    invoke-static/range {v16 .. v16}, Lorg/apache/log4j/PropertyConfigurator;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v16

    sput-object v16, Lorg/apache/log4j/PropertyConfigurator;->class$org$apache$log4j$Appender:Ljava/lang/Class;
    ...
    invoke-static {v0, v15, v1, v2}, Lorg/apache/log4j/helpers/OptionConverter;->instantiateByKey(Ljava/util/Properties;Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v17, "Could not instantiate appender named \""
    ...
    invoke-static/range {v16 .. v16}, Lorg/apache/log4j/helpers/LogLog;->error(Ljava/lang/String;)V
    ...
    .line 795
    instance-of v0, v3, Lorg/apache/log4j/spi/OptionHandler;
    ...
    .line 797
    sget-object v16, Lorg/apache/log4j/PropertyConfigurator;->class$org$apache$log4j$Layout:Ljava/lang/Class;

    if-nez v16, :cond_6

    const-string v16, "org.apache.log4j.Layout"

    invoke-static/range {v16 .. v16}, Lorg/apache/log4j/PropertyConfigurator;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v16

    sput-object v16, Lorg/apache/log4j/PropertyConfigurator;->class$org$apache$log4j$Layout:Ljava/lang/Class;
    ...
    invoke-static {v0, v14, v1, v2}, Lorg/apache/log4j/helpers/OptionConverter;->instantiateByKey(Ljava/util/Properties;Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v13

    check-cast v13, Lorg/apache/log4j/Layout;

    .line 801
    .local v13, "layout":Lorg/apache/log4j/Layout;
    if-eqz v13, :cond_3

    .line 802
    invoke-interface {v3, v13}, Lorg/apache/log4j/Appender;->setLayout(Lorg/apache/log4j/Layout;)V
    ...
    const-string v17, "Parsing layout options for \""
    ...
    invoke-static {v13, v0, v1}, Lorg/apache/log4j/config/PropertySetter;->setProperties(Ljava/lang/Object;Ljava/util/Properties;Ljava/lang/String;)V
    ...
    const-string v17, "End of parsing for \""
    ...
    .line 809
    .end local v13    # "layout":Lorg/apache/log4j/Layout;
    :cond_3
    new-instance v16, Ljava/lang/StringBuffer;
    ...
    .line 810
    .local v9, "errorHandlerPrefix":Ljava/lang/String;
    move-object/from16 v0, p1

    invoke-static {v9, v0}, Lorg/apache/log4j/helpers/OptionConverter;->findAndSubst(Ljava/lang/String;Ljava/util/Properties;)Ljava/lang/String;
    ...
    .line 812
    sget-object v16, Lorg/apache/log4j/PropertyConfigurator;->class$org$apache$log4j$spi$ErrorHandler:Ljava/lang/Class;

    if-nez v16, :cond_7

    const-string v16, "org.apache.log4j.spi.ErrorHandler"

    invoke-static/range {v16 .. v16}, Lorg/apache/log4j/PropertyConfigurator;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v16

    sput-object v16, Lorg/apache/log4j/PropertyConfigurator;->class$org$apache$log4j$spi$ErrorHandler:Ljava/lang/Class;
    ...
    invoke-static {v0, v9, v1, v2}, Lorg/apache/log4j/helpers/OptionConverter;->instantiateByKey(Ljava/util/Properties;Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 817
    invoke-interface {v3, v6}, Lorg/apache/log4j/Appender;->setErrorHandler(Lorg/apache/log4j/spi/ErrorHandler;)V
    ...
    const-string v17, "Parsing errorhandler options for \""
    ...
    iget-object v0, v0, Lorg/apache/log4j/PropertyConfigurator;->repository:Lorg/apache/log4j/spi/LoggerRepository;
    ...
    invoke-direct {v0, v6, v9, v1, v2}, Lorg/apache/log4j/PropertyConfigurator;->parseErrorHandler(Lorg/apache/log4j/spi/ErrorHandler;Ljava/lang/String;Ljava/util/Properties;Lorg/apache/log4j/spi/LoggerRepository;)V
    ...
    .line 821
    .local v5, "edited":Ljava/util/Properties;
    const/16 v16, 0x3
    ...
    .line 812
    .restart local v8    # "errorHandlerClass":Ljava/lang/String;
    .restart local v9    # "errorHandlerPrefix":Ljava/lang/String;
    :cond_7
    sget-object v16, Lorg/apache/log4j/PropertyConfigurator;->class$org$apache$log4j$spi$ErrorHandler:Ljava/lang/Class;
    ...
    .line 829
    .restart local v5    # "edited":Ljava/util/Properties;
    ...
    .restart local v12    # "keys":[Ljava/lang/String;
    :cond_8
    ...
    invoke-static {v6, v5, v0}, Lorg/apache/log4j/config/PropertySetter;->setProperties(Ljava/lang/Object;Ljava/util/Properties;Ljava/lang/String;)V
    ...
    const-string v17, "End of errorhandler parsing for \""
    ...
    invoke-static {v3, v0, v1}, Lorg/apache/log4j/config/PropertySetter;->setProperties(Ljava/lang/Object;Ljava/util/Properties;Ljava/lang/String;)V
